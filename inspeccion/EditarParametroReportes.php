...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">		
			<div style="margin-bottom: 10px;">
				<div class="tblHeader">
					<div class="itemHeader" style="width: 30%;text-align: center;">Tipo Aud.</div>
					<div class="itemHeader" style="width: 50%;text-align: center;">Desc.</div>
					<div class="itemHeader" style="width: 20%;text-align: center;">Valor</div>
				</div>
	...
	<script type="text/javascript" src="js/ParametroReporte.js"></script>
</body>
</html>