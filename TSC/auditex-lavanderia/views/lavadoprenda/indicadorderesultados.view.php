...
<body>
        ...
        <?php if($showreport): ?>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-8 text-center">
                    <label for="" class="font-weight-bold">INDICADORES DE RESULTADOS DE AUDITORÍA LAVANDERIA PRENDA - GENERAL</label>
                    <br>
                    <label for="">
                ...
                <div class="col-8 mt-2">
                    ...
                    <table class="table table-sm table-bordered table-indicador" >
                        ...
                        <tbody id="tbodyindicador" class="font-weight-bold">
                ...
                <!-- ################### -->
                    ...
                    <!-- NIVEL 1 -->
                        ...
                        <div class="col-md-8 text-white mt-2 text-center " style="font-size: 13px !important;">
                            <hr>
                            <label class="w-100 font-weight-bold" style="font-size: 15px !important;">DIAGRAMA DE PARETO GENERAL - NIVEL N°1</label>
                    ...
                    <!-- ############### -->
                        ...
                        <div class="col-md-8 text-white mt-2 text-center" style="font-size: 13px !important;">
                            <hr>
                            <label class="w-100 font-weight-bold" style="font-size: 15px !important;">DIAGRAMA DE PARETO GENERAL - NIVEL N°2</label>
    ...
    <script src="../../js/lavados/prenda/indicadorresultados.js"></script>
