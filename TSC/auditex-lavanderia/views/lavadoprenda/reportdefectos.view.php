<?php
    ...
    $_SESSION['navbar'] = "Auditex Lavanderia Prenda - Reporte Defectos";
    ...
    if(isset($_GET["operacion"])){
        ...
        $datareporte = $objModelo->getAll("AUDITEX.PQ_LAVANDERIA.SPU_GETREPORTES_PRENDAS",[3,$txtfechai,$txtfechaf,null,null,null]);
        $_SESSION["data_reporte_defectos_lavanderia_prendas"] = $datareporte;
    ...
    <script>
        ...
        window.addEventListener("load", async () => {
            ...
            $("#btnexportar").click(function(){
                ...
                window.open("/tsc/controllers/auditex-lavanderia/lavadoprenda.controller.php?operacion=get-report-defectos","_blank");
