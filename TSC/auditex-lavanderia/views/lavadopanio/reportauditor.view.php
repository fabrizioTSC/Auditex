<?php
    ...
    $_SESSION['navbar'] = "Auditex Lavanderia Paño - Reporte Auditor";
    ...
    if(isset($_GET["operacion"])){
        ...
        $datareporte = $objModelo->getAll("AUDITEX.PQ_LAVANDERIA.SPU_GETREPORTES_PANOS",[2,$txtfechai,$txtfechaf,null,null,null]);
        $_SESSION["data_reporte_auditor_lavanderia_panos"] = $datareporte;
            ...
            <table class="table table-bordered table-sm  text-center m-0 table-fichas">
                <thead class="thead-sistema-new">
                    <tr class="thead-fichas">
                        ...
                        <th class="w-bajo-2 align-vertical">CANT. PRENDAS</th>
                        <th class="w-bajo align-vertical">CANT. AUDITADAS</th>
                ...
                <tbody class="bg-white">
                    ...
                    <?php  foreach($datareporte as $fila): ?>
                        ...
                        <tr >
                            ...
                            <td class="w-bajo-2"> <?= $fila["PRENDAS"]; ?> </td>
                            <td class="w-bajo"> <?= $fila["AUDITADAS"]; ?> </td>
    ...
    <script>
        ...
        window.addEventListener("load", async () => {
            ...
            $("#btnexportar").click(function(){
                ...
                window.open("/tsc/controllers/auditex-lavanderia/lavadopanio.controller.php?operacion=get-report-auditor","_blank");
