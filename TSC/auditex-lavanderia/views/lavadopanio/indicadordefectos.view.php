            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8 text-center">
                        <label for="" class="font-weight-bold">INDICADOR DE DEFECTOS DE LAVADO EN PAÑO</label>   
                    </div>
    ...
    <script>
        ...
        window.addEventListener("load", async () => {
            ...
            $("#tbodydefectos").on('click','.selectdefecto',async function(){
                ...
                let anios_data   = await get("auditex-lavanderia","lavadopanio","get-indicador-defectos-detalle",parameters);
                parameters.opcion = 2;
                let meses_data     = await get("auditex-lavanderia","lavadopanio","get-indicador-defectos-detalle",parameters);
                parameters.opcion = 3;
                let semanas_data  = await get("auditex-lavanderia","lavadopanio","get-indicador-defectos-detalle",parameters);
                ...
                $("#lbldefectoindicador").text(DEFECTOINDICADOR);
        ...
        async function getReporte(){
           ...
           // OBTENEMOS MUESTRA
           let muestratotal = await get("auditex-lavanderia","lavadopanio","get-muestra-indicador-defectos",{
            ...
            let response = await get("auditex-lavanderia","lavadopanio","get-indicador-defectos",{
        ...
        function setTableIndicador(data){
            ...
            for(let item of data){
                ...
                let porcentaje = parseFloat(item.TOTALDEFECTO) / parseFloat(item.MUESTRA);
