    ...
    <div class="contaier" id="containerindicador" style="display:none" >
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-10 text-center">
                <label for="" class="font-weight-bold">INDICADORES POR AUDITOR - CORTE PROCESO</label>
                <br>
                <label id="lblfiltros">
                </label>
            </div>
...
<script>
    ...
    async function getAuditores(){
        let response = await get("auditex-generales","generales","getauditorescorteproceso",{ });
    ...
    function GetDataIndicador(){
        ...
        MostrarCarga();
        get("auditex-corte","auditoriaproceso","getindicadorauditor",{
