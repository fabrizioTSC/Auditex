    ...
    <div class="contaier" id="containerindicador" style="display:none" >
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-10 text-center">
                <label for="" class="font-weight-bold">INDICADORES POR AUDITOR - CORTE FINAL</label>
                <br>
                <label id="lblfiltros">
                </label>
            </div>
...
<script>
    ...
    async function getAuditores(){
        let response = await get("auditex-generales","generales","getauditorescortefinal",{ });
    ...
    function GetDataIndicador(){
        ...
        MostrarCarga();
        get("auditex-corte","auditoriafinal","getindicadorauditor",{
