<?php
    ...
    $_SESSION['navbar'] = "Modificar Medidas Auditables - Interna";
...
<body>
    ...
    <script>
        ...
        function getMedidas(){
            ...
            get("auditex-interna", "medidasauditables", "getmedidas", {
                estilotsc
                // opcion:1,
                // idficha,
                // ficha,
        ...
        $("#btnguardar").click(async function(){
            ...
            for(let item of checks){
                ...
                let response = await post("auditex-interna","medidasauditables","setmedidas",[3,estilotsc,codigomedida,check]);  
                // console.log(response);
