<?php
    ...
    $_SESSION['navbar'] = "Reporte de Desviación de Medidas - Interna";
...
<body>
    ...
    <div class="container-fluid mt-3">
        ...
        <?php else: ?>
            ...
            <?php
                ...
                $fichasmostrar     = isset($_POST["fichas"]) ? implode(",",$_POST["fichas"]) : null;

                $estilotsc  = $_POST["estilotsc"];

                // EXTRAEMOS DATOS
                $infoestilo             = $objModelo->get("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[4,1,$estilotsc,$fichas]);
                $tallasestilo           = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[4,2,$estilotsc,$fichas]);
                $medidasestilo          = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[4,3,$estilotsc,$fichas]);
                $desviacionesestilo     = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[4,4,$estilotsc,$fichas]);
                $dataestilo             = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[4,5,$estilotsc,$fichas]);
            ...
            <div class="row justify-content-center">   
                ...
                <!-- <div class="col-md-12 text-white font-weight-bold">
                    <label class="float-left w-100" for="">ESTILO TSC: <?= $infoestilo["ESTTSC"] ?> </label>
                    <label class="float-left w-100">PEDIDOS/COLOR: <?= $fichasmostrar == null ? "TODAS" : $fichasmostrar;  ?> </label> 
                    <label class="float-left w-100">ESTILO CLIENTE: <?= $infoestilo["ESTCLI"] ?> </label> 
                    <label class="float-left w-100">CLIENTE: <?= $infoestilo["DESCLI"] ?> </label> 
                ...
                <div class="col-md-12 text-white font-weight-bold mb-2">
                    ...
                    <label class="float-left w-100" style="margin-bottom: 0px !important;">FICHAS: <?= $fichasmostrar == null ? "TODAS" : $fichasmostrar;  ?> </label> 
                    ...
                    <a class="btn btn-sm btn-danger" href="/tsc/auditex-generales/views/desviacionmedidas/pdf.report.php?area=INTERNA&estilotsc=<?= $infoestilo["ESTTSC"] ?>&fichas=<?= $fichasmostrar == null ? "TODAS" : $fichasmostrar;  ?>&estilocliente=<?= $infoestilo["ESTCLI"] ?>&cliente=<?= $infoestilo["DESCLI"] ?>" target="_blank">
    ...
    <script>
        ...
        function getFichas(estilotsc){
            ...
            $(".loader").fadeIn();
            getsync("auditex-interna","reportedesviacion","getfichasestilo",{estilotsc,opcion:8},function(e){
