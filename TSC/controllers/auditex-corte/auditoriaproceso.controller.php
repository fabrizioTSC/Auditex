    ...
    if(isset($_GET["operacion"])){
        ...
        if($_GET["operacion"] == "getindicadorauditor"){
            ...
            $response_auditor = $objModelo->getAll("AUDITEX.PQ_INDICADORES_AUDITOR.SPU_GETDATOS_INDICADOR",[
                1,$sede,$tiposervicio,$codtaller,$auditor,$tipofiltro,$anio,$mes,$semana,$fechai,$fechaf
            ]);

            $response_defecto = $objModelo->getAll("AUDITEX.PQ_INDICADORES_AUDITOR.SPU_GETDATOS_INDICADOR",[
                2,$sede,$tiposervicio,$codtaller,$auditor,$tipofiltro,$anio,$mes,$semana,$fechai,$fechaf
            ]);
        ...
        // DEFECTOS DE LA FICHA
        // if($_GET["operacion"] == "getindicadorauditorpareto"){
        ...
        //     $response = $objModelo->getAll("AUDITEX.PQ_INDICADORES_AUDITOR.SPU_GETDATOS_INDICADOR",[
        //         2,$sede,$tiposervicio,$codtaller,$auditor,$tipofiltro,$anio,$mes,$semana,$fechai,$fechaf
        //     ]);
        //     echo json_encode($response);
