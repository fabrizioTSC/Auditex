<?php
    ...
    $_SESSION['navbar'] = "Reporte de Desviación de Medidas - Acabados";
...
<body>
    ...
    <div class="container-fluid mt-3">
        ...
        <?php else: ?>
            ...
            <?php
                ...
                // EXTRAEMOS DATOS
                $infoestilo             = $objModelo->get("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[3,1,$estilotsc,$fichas]);
                $tallasestilo           = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[3,2,$estilotsc,$fichas]);
                $medidasestilo          = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[3,3,$estilotsc,$fichas]);
                $desviacionesestilo     = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[3,4,$estilotsc,$fichas]);
                $dataestilo             = $objModelo->getAll("AUDITEX.PQ_MEDIDAS.SPU_GETDATOSMEDIDASREPORTE",[3,5,$estilotsc,$fichas]);
            ...
            <div class="row justify-content-center">   
                ...
                <div class="col-md-12 text-white font-weight-bold mb-2">
                    ...
                    <a class="btn btn-sm btn-danger" href="/tsc/auditex-generales/views/desviacionmedidas/pdf.report.php?area=ACABADOS&estilotsc=<?= $infoestilo["ESTTSC"] ?>&fichas=<?= $fichas == null ? "TODAS" : $fichas;  ?>&estilocliente=<?= $infoestilo["ESTCLI"] ?>&cliente=<?= $infoestilo["DESCLI"] ?>" target="_blank">
    ...
    <script>
        ...
        function getFichas(estilotsc){
            ...
            $(".loader").fadeIn();
            getsync("auditex-acabados","reportedesviacion","getfichasestilo",{estilotsc},function(e){
