<?php
    ...
    $_SESSION['navbar'] = "Eliminar Auditoria Proceso - Costura";
...
<div class="container mt-3"> 
    ...
    <?php
        ...
        if(isset($_GET["ficha"])){
            ...
            $ficha = $_GET["ficha"];
            $dataficha = $objModelo->getAll("AUDITEX.PQ_MODAUDITEX.SPU_GETFICHASAUDITORIA",[1,$ficha]);
            // var_dump($dataficha);
        }
    ?>
    ...
    $(".eliminaraud").click(async function(){
        ...
        if(rpt.value){
            ...
            post("auditex-generales","generales","setdeleteauditorias",[
                1,idficha,ficha,parte,vez,"<?= $_SESSION["user"]  ?>"
            ])
                .then(response => {
