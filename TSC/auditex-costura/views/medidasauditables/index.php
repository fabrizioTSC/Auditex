<?php
    ...
    $_SESSION['navbar'] = "Modificar Medidas Auditables - Costura";
...
<body>
    ...
    <script>
        ...
        function getMedidas(){
            ...
            get("auditex-costura", "medidasauditables", "getmedidas", {
                estilotsc
                // opcion:1,
                // idficha,
                // ficha,
        ...
        $("#btnguardar").click(async function(){
            ...
            for(let item of checks){
                ...
                let response = await post("auditex-costura","medidasauditables","setmedidas",[4,estilotsc,codigomedida,check]);  
                // console.log(response);
