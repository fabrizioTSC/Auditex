...
class ExcelGeneralModelo extends Spreadsheet
{


    function getExcel($namefile,$titulo, $columnas,$data)
    {
        ...
        try{
            ...
            foreach($columnas as $col){
                ...
                $celda = "{$colname}{$iniciofilas}";
                $sheet->setCellValue('A4',$col);
                $iniciocolumna++;
            ...
            // // TEXTO CENTRADO
            // $sheet->getStyle('A4:BI5')->getAlignment()->setWrapText(true); 

            // // BACKGROUP
            // $objExcelAjustes->setBackground($spreadsheet,"A4:BI5","D9D9D9");
            // $objExcelAjustes->setBackground($spreadsheet,"AV4:AX5","C4D79B");
            
            // // NEGRITA
            // $sheet->getStyle("A4:BI5")->applyFromArray($ajustes["negrita"]);
            ...
            #REGION TIPO DE DATOS
                ...
                // $sheet->getStyle("A4:BI{$inicio}")->getAlignment()->setHorizontal('center');
                // $sheet->getStyle("A4:BI{$inicio}")->getAlignment()->setVertical('center');

                // // BORDES
                // $sheet->getStyle("A4:BI{$inicio}")->applyFromArray($ajustes["bordes"]);
