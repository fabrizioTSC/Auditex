<?php
    ...
    $_SESSION['navbar'] = "Auditex Telas - I. Est. Dimensional";
...
<body>
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <label for="" class="font-weight-bold" >Dimenciones:</label>
    ...
    <script>
        ...
        async function SetGraficoGeneral(){
            ...
            canvas.onclick = async function(evt) {
                ...
                if (activePoints[0]) {
                    ...
                    // AREAS
                    let responseareas           = await GetDataDetalle(filtro,32,'DESESTDIM','PESOAUD','CODESTDIM','CANTIDAD','chart-1-detalle-','CARACTERISTICAS','','');
                    // MOTIVOS
                    let responseareasmotivos    = await GetDataDetalle(filtro,33,'DSCCOL','PESOAUD','CODCOL','CANTIDAD','chart-2-detalle-','COLOR',responseareas.mayor1des,'');
                    // ARTICULOS
                    let responsearticulos       = await GetDataDetalle(filtro,34,'DESTEL','PESOAUD','CODTEL','CANTIDAD','chart-3-detalle-','ARTICULOS',responseareas.mayor1des,responseareasmotivos.mayor1des);

                    // ARTICULOS A DETALLE
                    await ArmarTablaArticulos(filtro,responseareas.mayor1des,responseareasmotivos.mayor1des);
                    // ARMAMOS INDICADOR
                    await SetIndicadorGeneral(responseareas.mayor1des);
                    OcultarCarga();
        ...
        // GET DATA DETALLE
        async function GetDataDetalle(filtro,opcion = 32,descripcion_grap = '',valor_grap = '',codigo_grap = '',cantidad_grap = '',chart_grap = '',titulo_grap = '',filtro2 = '',filtro3 = ''){
            ...
            canvas.onclick = async function(evt) {
                ...
                if (activePoints[0]) {
                    ...
                    if(titulo_grap == "CARACTERISTICAS"){
                        ...
                        await GetDataDetalle(filtro,33,'DSCCOL','PESOAUD','CODCOL','CANTIDAD','chart-2-detalle-','COLOR',label,'');
                    ...
                    if(titulo_grap == "COLOR"){
                        ...
                        await GetDataDetalle(filtro,34,'DESTEL','PESOAUD','CODTEL','CANTIDAD','chart-3-detalle-','ARTICULOS',filtro2,label);
