...
<body>
    ...
    <script>
        ...
        // GET DATA DETALLE
        async function GetDataDetalle(filtro,opcion = 21,descripcion_grap = '',valor_grap = '',codigo_grap = '',cantidad_grap = '',chart_grap = '',titulo_grap = '',filtro2 = '',filtro3 = ''){
        ...
        //     let response        = await get("auditex-tela","indicadores","get-data-filtros-indicador",{});
        //     setComboSimple('cboproveedor',response.proveedores,'PROVEEDOR','CODPRV');
        //     setComboSimple('cbocliente',response.clientes,'CLIENTE','CODCLI');
        //     setComboSimple('cboprograma',response.programas,'PROGRAMA','PROGRAMA');
        //     setComboSimple('cbotelas',response.telas,'CODTEL','CODTEL');
        //     setComboSimple('cbocolor',response.colores,'DSCCOL','DSCCOL');
        ...
        //     let canvas  = document.getElementById("pie-chartcanvas");
        //     var ctx     = canvas.getContext("2d"); //$("#pie-chartcanvas-1");
        ...
        //         {
        //             // label: "TeamA Score",
        //             data: [aprobadas.length,rechazadas.length,concecionada.length],
        //             backgroundColor: [
        //                 "#4bc0c0",
        //                 "#ff6384",
        //                 "#ff9f40",
        ...
        // // GET DATA DETALLE
        // async function GetDataDetalle(tipoletra){

        //     let filtro = null;
        //     if(tipoletra == "Aprobadas") {filtro = "A";}
        //     if(tipoletra == "Rechazadas") {filtro = "R";}
        //     if(tipoletra == "Aprobadas no conforme") {filtro = "C";}
        ...
        //         // id.push(item.CODAREAD);
        //         valores.push(item.CANTIDAD);
        //         descripciones.push(item.DSCAREAD);
        //     }

        //     let dataretornada = setGraficoBarraGeneral('chart-1-detalle-', {
        ...
        //             // GetDataDetalleMotivos(3,filtro,label,'','chart-2-detalle-','MOTIVO DE DEFECTOS','DESDEF');

        //             let filtrodef_a = await GetDataDetalleMotivos(22,filtro,label,'','chart-2-detalle-','MOTIVOS','DESAPA');
        //             let filtrotel_a = await GetDataDetalleMotivos(23,filtro,label,filtrodef_a,'chart-3-detalle-','TELAS','DESTEL');
        //         }
        //     };

        //     // MOTIVOS POR DEFECTOS
        //     let filtrodef = await GetDataDetalleMotivos(22,filtro,descripciones[0],'','chart-2-detalle-','MOTIVOS','DESAPA');
        //     // console.log('filtrodef',filtrodef);
        //     let filtrotel = await GetDataDetalleMotivos(23,filtro,descripciones[0],filtrodef,'chart-3-detalle-','TELAS','DESTEL');
        ...
        // // DETALLE DE MOTIVOS
        // async function GetDataDetalleMotivos(opcion,filtro,filtro2,filtro3,chartnombre,descripcionlabel,descripciondata){

        //     // DATA DETALLE 2
        //     let response2      = await get("auditex-tela","indicadores","get-data-indicadorgeneral-detalle",{
        //         opcion,
        //         filtro,
        //         filtro2,
        //         filtro3,
        ...
        //         valores2.push(item.CANTIDAD);
        //         descripciones2.push(item[descripciondata]);
        //     }

        //     let dataretornada = setGraficoBarraGeneral(chartnombre, {
        //         valores:valores2,descripciones:descripciones2
        //     }, descripcionlabel);
        ...
        //             await GetDataDetalleMotivos(23,filtro,filtro2,label,'chart-3-detalle-','TELAS','DESTEL');
        //         }
        //     };
        ...
        //         // ARMAMOS TABLA ARTICULOS
        //         await ArmarTablaArticulos(filtro,filtro2,filtro3);

        //         // ARMAMOS INDICADOR
        //         await SetIndicadorGeneral(filtro3);
        //     }


        //     return descripciones2 ? descripciones2[0] : '';
        ...
        //     console.log('RESPONSE INDICADOR',data);
