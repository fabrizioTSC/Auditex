<?php
    ...
    $_SESSION['navbar'] = "Auditex Telas - I. Defectos";
...
<body>
    ...
    <script>
        ...
        async function SetGraficoGeneral(){
            ...
            canvas.onclick = async function(evt) {
                ...
                if (activePoints[0]) {
                    ...
                    // NUEO INDICADOR
                    await SetIndicadorToneladas(responseareasmotivos.mayor1des);
        ...
        // GET DATA DETALLE
        async function GetDataDetalle(filtro,opcion = 2,descripcion_grap = '',valor_grap = '',codigo_grap = '',cantidad_grap = '',chart_grap = '',titulo_grap = '',filtro2 = '',filtro3 = ''){
            ...
            canvas.onclick = async function(evt) {
                ...
                if (activePoints[0]) {
                    ...
                    if(titulo_grap == "DEFECTOS"){
                        ...
                        // NUEO INDICADOR
                        await SetIndicadorToneladas(label);
        ...
        async function SetIndicadorToneladas(filtro3){
        ...
        //             let filtrodef_a = await GetDataDetalleMotivos(3,filtro,label,'','chart-2-detalle-','MOTIVO DE DEFECTOS','DESDEF');
        //             let filtrotel_a = await GetDataDetalleMotivos(4,filtro,label,filtrodef_a,'chart-3-detalle-','TELAS','DESTEL');
        //         }
        //     };

        //     // MOTIVOS POR DEFECTOS
        //     let filtrodef = await GetDataDetalleMotivos(3,filtro,descripciones[0],'','chart-2-detalle-','MOTIVO DE DEFECTOS','DESDEF');
        //     // console.log('filtrodef',filtrodef);
        //     let filtrotel = await GetDataDetalleMotivos(4,filtro,descripciones[0],filtrodef,'chart-3-detalle-','TELAS','DESTEL');
        ...
        //             await GetDataDetalleMotivos(4,filtro,filtro2,label,'chart-3-detalle-','TELAS','DESTEL');
        //         }
        //     };
