...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE AUDITOR&Iacute;A PROCESO DE CORTE</div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2"># AUD. APROB.</div>
	...
	<script type="text/javascript">
		var codusu='<?php echo $_SESSION['user-afc']; ?>';
	...
	<script type="text/javascript" src="js/IndicadorResultados-v1.0.js"></script>
