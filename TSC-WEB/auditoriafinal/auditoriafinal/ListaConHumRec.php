...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Control de Humedad Rec.</div>
			...
			<div class="mainContent" style="margin-top: 5px; display: block;" id="tablepartidas">
				<div class="tblContent" style="overflow-x: scroll;">
					<div class="tblHeader" style="width: auto;">
						...
						<div class="itemHeader" style="width:100px;">HUM MAX</div>
						<div class="itemHeader" style="width:100px;">HUM PRO</div>
					</div>
					<div class="tblBody" style="width: 970px;" id="table-body">
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
				...
				success:function(data){
					...
					if (data.state) {
						for (var i = 0; i < ar_fichas.length; i++) {
							html+=
								'<div style="display: flex;" onclick="show_detail(\''+ar_fichas[i].PEDIDO+'\',\''+ar_fichas[i].DESCOL+'\')">'+
									...
									'<div class="itemBody" style="width:100px;">'+ar_fichas[i].HUMMAX+'</div>'+
									'<div class="itemBody" style="width:100px;">'+ar_fichas[i].HUMPRO+'</div>'+
								'</div>';
						}
						$("#table-body").empty();
		...
		function show_detail(pedido,color){
			window.location.href="ConAudConHum.php?pedido="+pedido+"&color="+color;
		}
	</script>
</body>
</html>