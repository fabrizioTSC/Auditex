	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">			
			...
			<?php
				...
				// ####### PEDIDO
				if($pedidopasar != null){
					$responsesige = $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[4,$pedidopasar],"Correcto");
				}else{ // ####### PO
					$responsesige = $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[5,null,null,null,null,$popasar],"Correcto");
				}
