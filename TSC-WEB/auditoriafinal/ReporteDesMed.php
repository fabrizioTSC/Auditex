...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="title-medida">Pedido: <?php if($_GET['pedido']!="0"){echo $_GET['pedido'];}else{ echo "TODOS";} ?></div>
			<div class="title-medida">Color: <?php if($_GET['color']!="0"){echo $_GET['color'];}else{ echo "TODOS";} ?></div>
			...
			<div class="btnPrimary" onclick="window.history.back();">Volver</div>
		</div>
	</div>
