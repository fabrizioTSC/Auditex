...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Indicador de Resultados Verificado de Empaque</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE AUDITOR&Iacute;A VERIFICADO DE EMPAQUE - GENERAL</div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2">CAJAS APROB. 1RA</div>
					<div class="items1 items2">CAJAS RECH.</div>
					<div class="items1 items2">TOTAL CAJAS</div>
					<div class="items1">% APRO. 1RA</div>
					<div class="items1">% RECH.</div>
				</div>
	...
	<script type="text/javascript" src="js/IndicadorResultadosVerEmp-v1.0.js"></script>
