...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte por Auditor y Fecha Embalaje Auditoria Final</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine bodyPrimary" style="display: flex;">
				<button class="btnPrimary" style="width: auto;margin-right: 5px;" onclick="consultar('ReporteAuditorFechaEmb.php')">Consultar</button>
				<div class="btnPrimary" style="width: 135px;margin-right: 5px;
				padding: 5px;display: flex;padding-left: 20px;" onclick="exportarAuditorFechaEmb()" id="spaceBtnExport">
			...
			if (isset($_GET['fecini'])) {
				...
				$sql="BEGIN SP_AF_REPVEREMP_EJECUTIVO(:FECINI,:FECFIN,:OPCION,:OUTPUT_CUR); END;";
			...
			<div style="margin-top: 10px;width: 100%;">
				<div class="rowLine" style="display: block;">
					<div class="tblPrendasDefecto" style="overflow-x: scroll;">
						<div class="tblHeader" style="width: 900px">
							...
							<div class="itemHeader2" style="width: 90px;">Can Caj</div>
							<div class="itemHeader2" style="width: 90px;">Can Prendas</div>
							<div class="itemHeader2" style="width: 90px;">Can Caj Mue</div>
							<div class="itemHeader2" style="width: 90px;">Can Pre Mue</div>
						</div>
						<div class="tblBody" style="width: 900px">
				<?php
