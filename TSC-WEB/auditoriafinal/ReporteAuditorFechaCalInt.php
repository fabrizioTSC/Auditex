...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte por Auditor y Fecha Calidad Interna</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine bodyPrimary" style="display: flex;">
				<button class="btnPrimary" style="width: auto;margin-right: 5px;" onclick="consultar('ReporteAuditorFechaCalInt.php')">Consultar</button>
				<div class="btnPrimary" style="width: 135px;margin-right: 5px;
				padding: 5px;display: flex;padding-left: 20px;" onclick="exportarAuditorFechaCalInt()" id="spaceBtnExport">
			...
			if (isset($_GET['fecini'])) {
				...
				$sql="BEGIN SP_AF_REPCAL_EJECUTIVO(:FECINI,:FECFIN,:OPCION,:OUTPUT_CUR); END;";
			...
			<div style="margin-top: 10px;width: 100%;">
				<div class="rowLine" style="display: block;">
					<div class="tblPrendasDefecto" style="overflow-x: scroll;">
						<div class="tblHeader" style="width: 1000px">
							...
							<div class="itemHeader2" style="width: 90px;">Prendas</div>
							<div class="itemHeader2" style="width: 90px;">Pre Mue</div>
							<div class="itemHeader2" style="width: 90px;">Defectos</div>
							<div class="itemHeader2" style="width: 90px;">Pre Apr</div>
							<div class="itemHeader2" style="width: 90px;">Pre Rec</div>
						</div>
						<div class="tblBody" style="width: 1000px">
				<?php
				...
				?>
							<div class="tblLine">
								...
								<div class="itemBody2" style="width: 90px;"><?php echo $row['PRENDASAPR']; ?></div>
								<div class="itemBody2" style="width: 90px;"><?php echo $row['PRENDASREC']; ?></div>	
							</div>
				<?php
						}
