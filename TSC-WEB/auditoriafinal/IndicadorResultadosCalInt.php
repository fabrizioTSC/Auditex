...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Indicador de Resultados Calidad Interna</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE AUDITOR&Iacute;A CALIDAD INTERNA - GENERAL</div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2">PREN APROB. 1RA</div>
					<div class="items1 items2">PREN RECH.</div>
	...
	<script type="text/javascript" src="js/IndicadorResultadosCalInt-v1.0.js"></script>
