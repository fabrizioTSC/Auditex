...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Control de Humedad</div>
		...
		<div class="bodyContent mainBodyContent">
			<div class="rowLine bodyPrimary">
				...
				<div style="display: flex">
					<div class="rowLineFlex">
						<div class="lblNew" style="width: 70px;margin-right: 5px;">Cantidad</div>
						<div class="spaceIpt" style="width: calc(100% - 70px);">
							<div class="valueRequest" id="idcantidad"></div>
						</div>
					</div>
					<div class="rowLineFlex">
						<div class="lblNew" style="width: 70px;margin-right: 5px;">Prenda</div>
						<div class="spaceIpt" style="width: calc(100% - 70px);">
			...
			<div style="display: flex;margin-top: 5px;">
				<div class="rowLineFlex">
					...
					<div class="spaceIpt" style="width: calc(100% - 80px);">
						<select id="idResultado" class="classCmbBox" style="width: calc(100% - 12px);" disabled>
			...
			<div style="margin-top: 5px;" id="div-obs-foto">
				<div class="lblNew" style="width: 150px;margin-right: 5px;">Observación foto:</div>
				<textarea style="padding: 5px;font-family: sans-serif;width: calc(100% - 12px);" id="idObs-foto"></textarea>
			</div>
			<button class="btnPrimary" onclick="delete_img()" id="btn-del">Eliminar imagen</button>
			<div class="lineDecoration"></div>
			<center>
				<button class="btnPrimary" id="btn-end" onclick="terminar_auditora()" style="margin: auto;margin-top: 10px;">Terminar</button>
	...
	$.ajax({
		...
		success:function(data){
			...
			if (data.close) {
				...
				document.getElementById("btn-end").remove();
				//window.history.back();
			}
			if (data.state) {
				...
				if (data.datos.OBSFOT!=null && data.datos.OBSFOT!="") {
					document.getElementById("idObs-foto").value=data.datos.OBSFOT;
					document.getElementById("obs-foto").value=data.datos.OBSFOT;
					document.getElementById("div-obs-foto").style.display="block";
				}else{
					document.getElementById("div-obs-foto").style.display="none";
				}
