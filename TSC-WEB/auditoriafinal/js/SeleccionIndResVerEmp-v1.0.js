	...
	/*if (codsede_var=="") {
		...
		if (codtipser_var=="") {
			...
			if (codtll_var=="") {
				...
				window.location.href="IndicadorResultadosCalInt.php?codsede="+codsede_var+"&codtipser="+codtipser_var+
				"&codtll="+codtll_var+"&fecha="+document.getElementById("idFecha").value;
			}
		}
	}*/
	window.location.href="IndicadorResultadosVerEmp.php?fecha="+document.getElementById("idFecha").value;
}