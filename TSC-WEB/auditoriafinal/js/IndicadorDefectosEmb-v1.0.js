...
$(document).ready(function(){
	$.ajax({
		...
		url:"config/getInfoIndDefEmb.php",
	...
	$("#idNumAnio").change(function(){
		...
		$.ajax({
			...
			url:"config/getSemanasIndDefEmb.php",
			success:function(data){
				console.log(data);
				var html='';
				for (var i = 0; i < data.semanas.length; i++) {
	...
	$("#idNumSem").change(function(){
		...
		$.ajax({
			...
			url:"config/getNewInfoIndDefEmb.php",
			success:function(data){
				console.log(data);
				var html='';
				for (var i = 0; i < data.defectos.length; i++) {
...
function detalle_defecto(coddef,desdef){
	...
	$.ajax({
		...
		url:"config/getInfoIndDefXCodEmb.php",
		success:function(data){
			console.log(data);
...
function downloadPDF(){
	$.ajax({
	  	...
	  	success:function(data){
	  		...
	  		a.target="_blank";
	  		a.href="fpdf/crearPdfIndDefEmb.php?n="+data+
	  		"&t="+title+"&t2="+title2+
