...
function endRegistroMedida(){
	...
	$.ajax({
		...
		data:{
			pedido:pedido,
			dsccol:dsccol,
			cantidad:parseInt($("#CanXTalla").val())+parseInt($("#CanXTallaAdi").val())
		},
		success:function (data){
			console.log(data)
			// if (!data.state) {
