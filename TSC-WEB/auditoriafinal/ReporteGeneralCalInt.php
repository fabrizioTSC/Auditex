...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte General Calidad Interna</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			...
			<div class="mayorContent" id="main-table">
				<div class="rowLine" style="display: block;width: 1540px;">
					<div class="tblPrendasDefecto" style="position: relative;padding-bottom: 86px;">
						<div class="tblHeader">
							...
							<div class="itemHeader2" style="width: 80px;">AQL</div>
							...
							<div class="itemHeader2" style="width: 80px;">Cantidad</div>
							<div class="itemHeader2" style="width: 80px;">Can Muestra</div>
							<div class="itemHeader2" style="width: 80px;">Can Max Def</div>
							<div class="itemHeader2" style="width: 80px;">Defectos</div>
				...
				?>
							<div class="tblLine">
								...
								<div class="itemBody2" style="width: 80px;"><?php echo $row['PO_CLI']; ?></div>
								<div class="itemBody2" style="width: 80px;"><?php echo $row['NUMVEZ']; ?></div>
								<div class="itemBody2" style="width: 80px;"><?php echo $row['AQL']; ?></div>
								...
								<div class="itemBody2" style="width: 80px;"><?php echo $row['CANDEFMAX']; ?></div>
				...
				<?php
						if(oci_num_rows($OUTPUT_CUR)!=0){
				?>
						<div class="rowLine" id="totales" style="display: block;width: 1540px;position: absolute;bottom: 0;left:0;z-index: 11;background: #000;">
							<div class="tblLine" style="background: #000;color: #fff;border: none;">
								...
								<div class="itemBody2" style="width: 80px;"><?php echo number_format($suma); ?></div>
								<div class="itemBody2" style="width: 80px;"><?php echo number_format($sumcanaud); ?></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 80px;"><?php echo number_format($sumcandef); ?></div>
							...
							<div class="tblLine" style="background: #000;color: #fff;border: none;">
								...
								<div class="itemBody2" style="width: 80px;"><?php echo number_format($suma_a); ?></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 100px;"></div>
							...
							<div class="tblLine" style="background: #000;color: #fff;border: none;">
								...
								<div class="itemBody2" style="width: 80px;"><?php echo number_format($suma_r); ?></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 80px;"></div>
								<div class="itemBody2" style="width: 100px;"></div>
			...
			onclick="exportar_calint(<?php echo $_GET['codusu']; ?>,13,
