...
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("INDICADORES DE DEFECTOS EMBALAJE DE AUDITORIA FINAL"),0,0,'C');
$pdf->Ln();
...
$pdf->Output('D','Indicar de Defectos Embalaje Auditoria Final - '.str_replace("/","-",$_GET['t']).'.pdf',true);
