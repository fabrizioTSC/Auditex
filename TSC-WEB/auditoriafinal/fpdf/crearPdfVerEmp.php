...
$por_rec[0]="% RECH.";
$pre_apr=[];
$pre_apr[0]="CAJAS APRO. 1RA";
$pre_rec=[];
$pre_rec[0]="CAJAS RECH.";
$pre_tot=[];
$pre_tot[0]="TOTAL CAJAS";
$por_pre_apr=[];
...
$sql="BEGIN SP_AF_INDICADOR_VEREMP(:FECHA,:OPCION,:OUTPUT_CUR); END;";
...
$pdf->Ln();
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("VERIFICADO DE EMPAQUE - GENERAL"),0,0,'C');
$pdf->Ln();
...
$i=0;
$sumDefectosU=0;
$sql="BEGIN SP_AF_INDICADOR_VEREMPDET(:FECHA,:CODFAM,:OPCION,:OUTPUT_CUR); END;";
$stmt=oci_parse($conn, $sql);
oci_bind_by_name($stmt, ':FECHA', $fecha);
