...
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("INDICADORES DE DEFECTOS DE CALIDAD INTERNA"),0,0,'C');
$pdf->Ln();
...
$sql="BEGIN SP_AF_INDCAL_DEFECTOS(:OPCION,:CODDEF,:OUTPUT_CUR); END;";
...
$pdf->Output('D','Indicar de Defectos Calidad Interna - '.str_replace("/","-",$_GET['t']).'.pdf',true);
