...
$pdf->Ln();
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("CALIDAD INTERNA - GENERAL"),0,0,'C');
$pdf->Ln();
...
$pdf->Output('D','Indicar de Resultados Calidad Interna - '.str_replace("/","-",$_GET['t']).'.pdf',true);
//$pdf->Output('','',true);
