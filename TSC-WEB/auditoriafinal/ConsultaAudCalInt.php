	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					document.getElementById("idObservacion").innerHTML=data.datos.COMENTARIOS;
		...
		function fill_fotos(data){
			...
			for (var i = 0; i < data.length; i++) {
				...
				'<tr>'+
					'<td>'+
						'<div style="text-align: center;max-width:400px; width:100%;margin: 0 auto;">'+
							'<img src="http://textilweb.tsc.com.pe:81/tsc-web/auditoriafinal/assets/imgcalint/'+data[i].RUTIMA+'" style="width:100%;">'+
						'</div>'+
					'</td>'+
