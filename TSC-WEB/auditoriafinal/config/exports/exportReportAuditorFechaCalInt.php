...
header("Expires: 0");
$filename = "Reporte_numero_de_auditorías_por_Auditor_y_Fecha-Calidad_Interna.xls";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de n&uacute;mero de auditor&iacute;as por Auditor y Fecha - Calidad Interna</div>
<br>
...
<table>
	<thead>
		<tr>
			...
			<th style="border:1px solid #333;">Aud Apr</th>
			<th style="border:1px solid #333;">Aud Rec</th>
			...
			<th style="border:1px solid #333;">Pre Apr</th>
			<th style="border:1px solid #333;">Pre Rec</th>
		</tr>
	</thead>
	<tbody>
		<?php 
		...
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo $row['PRENDASAPR']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['PRENDASREC']; ?></td>
		</tr>
		<?php
			}
		?>
