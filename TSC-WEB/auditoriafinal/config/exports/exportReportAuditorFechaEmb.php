...
header("Expires: 0");
$filename = "Reporte_numero_de_auditorías_por_Auditor_y_Fecha-Embalaje.xls";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de n&uacute;mero de auditor&iacute;as por Auditor y Fecha - Embalaje</div>
<br>
...
<table>
	<thead>
		<tr>
			...
			<th style="border:1px solid #333;">Can Prendas</th>
			<th style="border:1px solid #333;">Can Caj Mue</th>
			<th style="border:1px solid #333;">Can Pre Mue</th>
		</tr>
	</thead>
	<tbody>
		<?php 
