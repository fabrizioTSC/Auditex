...
<body>		
	...
	<div class="mainContent">		
		<div class="headerContent">
			<div class="headerTitle">Reporte Minutos Compensados por Estilo</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			...
			<div class="content-table" style="height: calc(100vh - 200px);">
				<div class="table" style="width: 1130px;">
					<div class="tbl-header">
						<div class="head" style="width: 80px;">Fecha</div>
						<div class="head" style="width: 120px;">Cod. Usu.</div>
						...
						<div class="head" style="width: 80px;">Tie. Ori.</div>
					</div>
	...
	<script type="text/javascript" src="js/ReporteMinComEst-v1.0.js"></script>
