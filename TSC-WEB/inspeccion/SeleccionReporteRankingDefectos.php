...
<body onload="getTalleres()">
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro Reporte de Porcentaje de Prendas Defectuosas por L&iacute;nea - Turno</div>
		...
		<div class="bodyContent mainBodyContent">
			<div class="option-line">
				<div class="class-for-radio">
			  		<input class="input-radio-class" id="ipt1" type="radio" name="state" value="0"> A&ntilde;o/Mes
			  	</div>
			...
			<div class="option-line">
				<div class="class-for-radio">
			  		<input class="input-radio-class" id="ipt2" type="radio" name="state" value="1"> A&ntilde;o/Semana
			  	</div>
				<div class="class-for-selects">
			...
			<div class="option-line">
				<div class="class-for-radio">
			  		<input class="input-radio-class" id="ipt3" type="radio" name="state" value="2"> Rango fechas
			  	</div>
				<div class="class-for-selects">
	...
	<script type="text/javascript" src="js/FiltroReporteRankingDefectos-v1.0.js"></script>
