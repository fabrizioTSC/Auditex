<?php
	...
	oci_bind_by_name($stmt,':PREING',$preing,40); 
	oci_bind_by_name($stmt,':PREAUDAPR',$preaudapr,40);
	// oci_bind_by_name($stmt,':LINEADES',$lineades,40);
