...
header("Expires: 0");
$filename = "Reporte_minutos_compensados_ficha.xls";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de minutos compensados por Ficha</div>
<br>
...
<table>
	<thead>
		<tr>
			...
			<th style="border:1px solid #333;">Hora inicio</th>
			<th style="border:1px solid #333;">Hora fin</th>
			...
			<th style="border:1px solid #333;">Tiempo Com. Est.</th>
...
?>
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo $row['LINEA']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['TURNO']; ?></td>
			<td style="border:1px solid #333;"><?php echo format_for_hora($row['HORINI']); ?></td>
			<td style="border:1px solid #333;"><?php echo format_for_hora($row['HORFIN']); ?></td>
			...
			<td style="border:1px solid #333;"><?php echo str_replace(",",".",$row['TIE_COM_EST']); ?></td>
