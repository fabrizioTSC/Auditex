<?php
	...
	if($denominador!=0){
		...
		$uno->ant_eficiencia=round($mineficiencia*100/$denominador);
		$mineficacia=floatval($mineficacia);
		$uno->ant_eficacia=round($mineficacia*100/$denominador);
	}else{
		$uno->ant_eficiencia="-";
		$uno->ant_eficacia="-";
	}
	...
	if($denominador!=0){
		$mineficiencia=floatval($mineficiencia);
		$dos->ant_eficiencia=round($mineficiencia*100/$denominador);
		$mineficacia=floatval($mineficacia);
		$dos->ant_eficacia=round($mineficacia*100/$denominador);
	}else{
		$dos->ant_eficiencia="-";
		$dos->ant_eficacia="-";
	}
