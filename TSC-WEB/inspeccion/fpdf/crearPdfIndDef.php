...
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("INDICADORES DE DEFECTOS DE INSPECCIÓN DE COSTURA"),0,0,'C');
$pdf->Ln();
...
$num_def[0]="# DEF.";
$num_def_tot=[];
$num_def_tot[0]="# PRE. INS.";
$por_def=[];
$por_def[0]="% DEF.";
$por_rec=[];
$l=1;

$sql="BEGIN SP_INSP_INDICADOR_DEFECTOS(:CODLIN,:CODSED,:CODTIPSER,:OPCION,:CODDEF,:OUTPUT_CUR); END;";
$stmt=oci_parse($conn, $sql);
oci_bind_by_name($stmt, ':CODLIN', $_GET['cl']);
...
$pdf->Output('D','Indicar de Defectos - '.$_GET['t'].'.pdf',true);
