	...
	$.ajax({
		...
		success:function(data){
			...
			for (var i = 0; i < data.lineas.length; i++) {
				...
				html+=
					'<div class="tblLine" style="width: 2300px;">'+
						...
						'<div class="itemBody" style="width: 90px;text-align: center;">'+data.lineas[i].mineficienciacomest+'</div>'+
						'<div class="itemBody" style="width: 90px;text-align: center;">'+data.lineas[i].mineficaciacomest+'</div>'+
