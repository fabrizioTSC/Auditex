...
$(document).ready(function(){
	...
	$.ajax({
		...
		success:function(data){
			...
			fillContent(1,data.uno,array[0],arrades[0]);
			fillContent(2,data.dos,array[1],arrades[1]);
			activeRefresher();
...
function fillContent(pos,data,l,ldes = ""){
	if(l!="0"){
