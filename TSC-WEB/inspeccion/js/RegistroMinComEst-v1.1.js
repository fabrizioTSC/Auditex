	...
	for (var i = 0; i < data.length; i++) {
		html+=
			'<div class="tbl-linea">'+
				...
				'</div>'+
				'<div class="body-tbl tbl-in4" id="tot-'+data[i].ALTERNATIVA+'-'+data[i].RUTA+'" style="padding-top:8px;">'+data[i].MINCOST+'</div>'+
				'<div class="body-tbl tbl-in4">'+
					'<input type="text" class="simple-ipt ipt-obs" style="width:calc(100% - 12px);"/>'+
				'</div>'+
			'</div>';
	}
	html+=
