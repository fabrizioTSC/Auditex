	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 5px;">
			<div id="space1">
				...
				<div class="rowSameLine" style="margin-top: 5px;">
					<div class="lbl" style="width: 200px;">Fecha desde:</div>
					<input type="date" id="txtFechaInicio" class="classIpt" style="width: 150px;margin-right: 10px;" value="<?= date("Y-m-d"); ?>">
				</div>	

				<div class="rowSameLine" style="margin-top: 5px;">
					<div class="lbl" style="width: 200px;">Fecha hasta:</div>
					<input type="date" id="txtFechaFin" class="classIpt" style="width: 150px;margin-right: 10px;" value="<?= date("Y-m-d"); ?>">
				</div>	
