...
<body>
	...
	<div class="body-modaledit" id="modalEdit" style="display: none;font-family: sans-serif;">
		<div class="modaledit">
			<div class="lbl" style="padding: 0px;margin-bottom: 5px; text-align: center;">Defectos</div>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte Evoluci&oacute;n de Operaciones por Hora</div>
				...
				<div id="maintbl" style="overflow-x: scroll;height: calc(100vh - 161px);position: relative;margin-top: 10px;">
					<div class="tblData2" style="position: relative;">
						<div class="tbl-header" id="data-header" style="position: relative;z-index: 11;">
							<div class="head-tbl" style="width:200px;">OPERACIONES</div>
	...
	<script type="text/javascript" src="js/ReporteOpeHor-v1.0.js"></script>
</body>
</html>