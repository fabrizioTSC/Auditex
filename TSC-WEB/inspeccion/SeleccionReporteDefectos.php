...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Selecci&oacute;n Reporte Defectos de Inspecci&oacute;n</div>
		...
		<div class="rowLine">				
			...
			<div class="sameLine">
				...
				<input type="date" id="idFechaFin" class="iptClass" style="width: calc(100% - 140px);font-size: 15px;">
			</div>
		</div>
		<div class="sameline">
			<button class="btnPrimary" style="margin:auto;margin-top: 10px;" onclick="verreporte()">MOSTRAR REPORTE</button>
		</div>
	</div>
