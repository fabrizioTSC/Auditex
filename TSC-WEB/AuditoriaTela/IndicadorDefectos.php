...
<body>
	...
	<div class="modalContainer" id="idModal">
		<div class="modalBackground" style="max-height: calc(100vh - 60px);overflow-y: scroll;">
			...
			<div class="lblTitulo" style="color: #000;">ANÁLISIS DE DEFECTO: <span id="idDesDef"></span></div>
			<div class="lblTitulo" id="titulodetalle" style="color: #000;"></div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2">kg MUESTRA</div>
					<div class="items1 items3"># DEF. TOT.</div>
					<div class="items1"># DEF./tn</div>
				</div>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			<div class="lblTitulo">ANÁLISIS DE DEFECTOS</div>
			...
			<div class="contentTbl" style="display: block;">
				<div class="tblSpace" style="width: 100%;">
					<div class="contentHeAders">
						...
						<div class="items1" style="width: calc(15% - 10px);">kg MUESTRA</div>
						<div class="items1" style="width: calc(15% - 10px);">TOTAL</div>
						<div class="items1" style="width: calc(15% - 10px);">DEFECTOS/tn</div>
					</div>
			...
			<center>
				...
				padding: 5px;display: flex;padding-left: 20px;" onclick="descargar_inddef()" id="spaceBtnExport">
	...
	<script type="text/javascript">
		...
		var codpro='<?php echo $_GET["codpro"] ?>';
		var tipo=1;
	...
	<script type="text/javascript" src="js/IndicadorDefectos-v1.2.js"></script>
