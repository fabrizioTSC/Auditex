...
function mostraIndRes(){
	if (codprv_var=="") {
		...
		window.location.href="ReporteBloques.php?codprv="+codprv_var+"&codcli="+codcli_var+"&fecini="+document.getElementById("idfecini").value+
		"&fecfin="+document.getElementById("idfecfin").value
		+"&codusu="+codusu_var+"&codusueje="+codusueje_var+"&resultado="+$("#selectResultado").val();
	}
}