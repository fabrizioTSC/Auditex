...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Iniciar Auditoria de Tela Rectilineo</div>
		...
		<div class="bodyContent mainBodyContent">			
			...
			<div id="list-partidas" style="display: none;">
				...
				<div class="lbl" style="margin-bottom: : 10px;">Seleccione partida a auditar</div>
				<div>
					<div class="tblHeader">
	...
	<script type="text/javascript">
		function search_partida(){
			if ($("#idpartida").val()=="") {
				...
				$.ajax({
					type:'POST',
					url:'config/validarParTelRec.php',
					data:{
		...
		function send_page(codprv,codtel,codtad,parte,numvez){
			...
			window.location.href="AudTelRec.php?partida="+partida+"&codprv="+codprv+"&codtel="+codtel+"&codtad="+codtad+"&parte="+parte+"&numvez="+numvez;
		}
	</script>
</body>
</html>