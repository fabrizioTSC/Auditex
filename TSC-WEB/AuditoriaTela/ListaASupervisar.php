...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Partidas Supervisar</div>
			...
			<div class="mainContent" style="margin-top: 5px; display: block;" id="tablepartidas">
				<div class="tblContent" style="overflow-x: scroll;">
					<div class="tblHeader" style="width: auto;">
						...
						<div class="itemHeader" style="width:100px;">FEC. REC.</div>
						<div class="itemHeader" style="width:100px;">AUDITOR</div>
						<div class="itemHeader" style="width:100px;">COOR.</div>
					</div>
					<div class="tblBody" style="width: 870px;" id="table-body">
					</div>
				</div>
			</div>
			<div class="lineDecoration"></div>
			<!-- <button class="btnPrimary" style="margin-left: calc(50% - 80px); margin-top: 0px;" onclick="redirect('main.php')">Volver</button> -->
			<button class="btnPrimary" style="margin-left: calc(50% - 80px); margin-top: 0px;" onclick="goBack()">Volver</button>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){			
			$.ajax({
				type:'POST',
				url:'config/getPartidasASupervisar.php',
						...
						for (var i = 0; i < partidas_ar.length; i++) {
							html+=
								...
								'\''+partidas_ar[i].CODPRV+'\',\''+partidas_ar[i].NUMVEZ+'\',\''+partidas_ar[i].PARTE+'\',\''+partidas_ar[i].CODTAD+'\')">'+
									...
									'<div class="itemBody" style="width:100px;">'+partidas_ar[i].FECREC+'</div>'+
									'<div class="itemBody" style="width:100px;">'+partidas_ar[i].CODUSU+'</div>'+
									'<div class="itemBody" style="width:100px;">'+partidas_ar[i].CODUSUEJENUE+'</div>'+
								'</div>';
						}
						$("#table-body").empty();
		...
		function show_detail(partida,codtel,codprv,numvez,parte,codtad){
			window.location.href="SupervisarAuditoriaTela.php?partida="+partida.toUpperCase()+"&codtel="+codtel+"&codprv="+codprv+
