<?php
	...
	$sql="BEGIN SP_AUDTEL_INSERT_PARAUDESTCON (:PARTIDA, :CODTEL, :CODPRV,:CODTAD, :NUMVEZ, :PARTE,:CODUSU,:CODBLO,:CODAREA,:CODDEF); END;";
	...
	oci_bind_by_name($stmt, ':CODBLO', $_POST['codblo']);
	...
	if ($result) {
		...
		$response->detail="No se pudo solicitar el estudio de consumo";
	}
