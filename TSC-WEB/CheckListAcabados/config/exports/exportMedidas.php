...
$sql="BEGIN SP_AFC_SELECT_PREDETFICMED_J(:CODFIC,:HILO,:TRAVEZ,:largamanga,:OUTPUT_CUR); END;";
...
?>
<div style="font-weight: bold;">Hilo: <?php echo $_GET['hilo']; ?> - Travez: <?php echo $_GET['travez']; ?></div>
<?php
}else{
?>
<div style="font-weight: bold;">Hilo: <?php echo $_GET['hilo']; ?> - Travez: <?php echo $_GET['travez']; ?> - Largamanga: <?php echo $_GET['largamanga']; ?></div>
<?php
}
?>
<br>
