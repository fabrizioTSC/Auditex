	...
	<div class="mainContent" id="mainToScroll">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="forms-content" id="form-4" style="display: none;">
				...
				<button class="btnPrimary" style="margin-left: calc(50% - 80px); margin-top: 5px;" onclick="window.location.href='main.php';">Volver</button>
			</div>
			<button class="btnPrimary" style="margin-left: calc(50% - 80px); margin-top: 5px;" onclick="window.location.back();">Volver</button>
		</div>
	</div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if (data.state) {
						...
						let percent=parseInt(data.ficha.CANPAR)/parseInt(data.ficha.CANTIDAD);
						...
						for (var i = 0; i < data.dettal.length; i++) {
							...
							if (i!=data.dettal.length-1) {
								...
								value=data.ficha.CANPAR-sum_value;
							}
						...
						html1+=
							...
							'<tr>';
						html2+=
								'<td><center>'+data.ficha.CANPAR+'</center></td>'+
							'<tr>';
						html1+=html2+
						'</table>';
						...
						document.getElementById("idcantidad").innerHTML=data.ficha.CANPAR+" de "+data.ficha.CANTIDAD;
