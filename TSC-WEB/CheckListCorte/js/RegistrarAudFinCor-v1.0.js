...
function RegistrarMedidas(){
	window.location.href="RegistrarMedidasAudFinCor.php?codfic="+codFicha;//+"&codtll="+codtll_var+"&numvez="+fichaNumVez+
		//"&parte="+fichaParte+"&codtad="+fichaCodTad+"&codaql="+fichaCodAql;
}