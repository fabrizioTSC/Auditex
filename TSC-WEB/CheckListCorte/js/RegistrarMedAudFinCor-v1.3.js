...
function replicar_informacion(data){
	for (var i = 0; i < data.length; i++) {
		console.log(i);
		document.getElementsByClassName("contentButton-"+data[i].CODMED+"-"+data[i].CODTAL)[0].getElementsByClassName("dato-"+data[i].VALOR)[0].getElementsByClassName("span-"+data[i].NUMPRE)[0].innerText=data[i].NUMPRE;
	}
}
...
function download_excel(){
	var link="config/exports/exportMedidas.php?codfic="+codfic+"&hilo="+hilo+"&travez="+travez+"&largamanga="+largmanga;
