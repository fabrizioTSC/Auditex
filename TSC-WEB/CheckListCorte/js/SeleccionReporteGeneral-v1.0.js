...
function enviarParamaetros(){
	...
	window.location.href="ReporteGeneral.php?codusu="+codusu+"&estado="+estado+
	"&fecini="+fecini+"&fecfin="+fecfin+"&codsede="+codsede_var+"&codtipser="+codtipser_var+"&codtll="+codtll_var;
}
