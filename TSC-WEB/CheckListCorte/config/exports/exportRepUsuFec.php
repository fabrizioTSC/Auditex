...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de n&uacute;mero de auditor&iacute;as por Usuario y Fecha</div>
<br>
...
<table>
	<thead>
		<tr>
			...
			<th style="border:1px solid #333;">Check List</th>
			<th style="border:1px solid #333;">Cant. Terminada</th>
			<th style="border:1px solid #333;">Cant. Pendiente</th>
	...
	<tbody>
		...
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo $row['TERMINADO']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['PENDIENTE']; ?></td>
