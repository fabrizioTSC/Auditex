...
<body>
	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success:function(data){
					...
					if (data.state) {
						...
						if (data.partida.DESCEL!="") {
							$("#idtaller").text(data.partida.DESTLL+" - "+data.partida.DESCEL);	
						}else{
						...
						alert(data.detail);
						window.location.href="IniciarCheckListCorte.php";
					}
		...
		function validate_form1(){
			...
			if (obs.length>tam_obs) {
				alert("La observación no debe tener más de "+tam_obs+" caracteres!");
			}else{
