...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte de defectos de auditoría proceso de corte</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			...
			<?php
				...
				$sql="BEGIN  SP_APCR_REPORTE_DEFECTOS(:FECINI,:FECFIN,:CODTLL,:CODCEL,:CODUSU,:CODSED,:CODTIPSER,:OUTPUT_CUR); END;";
				$stmt=oci_parse($conn, $sql);
			...
			<div class="mayorContent">
				<div class="rowLine" style="display: block;width: 2310px;">
					<div class="tblPrendasDefecto">
						<div class="tblHeader">
							...
							<div class="itemHeader2" style="width: 190px;">Célula</div>
			...
			'<?php echo $_GET['fecini']; ?>','<?php echo $_GET['fecfin']; ?>','<?php echo $_GET['codsede']; ?>','<?php echo $_GET['codtipser']; ?>','<?php echo $titulo;?>','<?php echo $_GET['codcel'];?>')">
