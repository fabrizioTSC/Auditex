...
header("Expires: 0");
$filename = "Reporte_auditoria_medidas-Ficha_".$_GET['codfic'].".xls";
...
$sql="BEGIN SP_APCR_SELECT_PREDETFICMED(:CODFIC,:HILO,:TRAVEZ,:largamanga,:OUTPUT_CUR); END;";
...
oci_execute($OUTPUT_CUR);
?>
<div style="font-size: 20px;font-weight: bold;">Auditoria de medidas - AUDITORIA PROCESO DE CORTE</div>
<br>
