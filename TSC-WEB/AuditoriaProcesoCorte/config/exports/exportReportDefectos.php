...
header("Expires: 0");
$filename = "Reporte_defectos-Auditoria_proceso_corte.xls";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de defectos de auditor&iacute;a final de corte</div>
<br>
