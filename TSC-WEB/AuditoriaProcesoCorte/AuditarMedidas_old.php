...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Auditor&iacute;a de medidas en proceso</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="sameline" style="margin-top: 5px;">
				<label style="line-height: 38px;padding-right: 5px;">Resultado</label>
				<select id="idresultado" class="classCmbBox">
					<option value="">Ninguno</option>
					<option value="A">Aprobado</option>
					<option value="C">Aprobado no conforme</option>
				</select>
				<button class="btnPrimary" style="margin-left: 5px;width: 100px;height: 35px;" onclick="save_header()">Guardar</button>
			</div>
			<div style="display: none;" id="content-obs">
				<div style="margin-top: 5px;display: flex;flex-direction: column;">
					<label>Observación</label>
					<textarea style="padding: 5px;font-family: sans-serif;" id="idobservacion"></textarea>
				</div>
			</div>
			...
			<div id="content-main">
				...
				<div class="sameline">
					...
					<div class="btn-primary" onclick="delete_ficha()" style="width: 150px;margin-right: calc(50% - 150px);">Eliminar</div>
				...
				<div class="btn-primary" onclick="window.history.back();" style="margin-top: 10px;">Volver</div>
			</div>
	...
	<script type="text/javascript" src="js/AuditarMedidas-v1.4.js"></script>
