...
<body onload="getTalleres()">
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">	
			...
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 80px;padding-top: 5px;">Celulas</div>
				<input type="text" id="celula" class="iptClass" style="width: calc(100% - 80px);font-size: 15px;">
			</div>
			<div class="tblSelection">
			...
			<div style="width: 100%;height: 20px;" style="display: none;"></div>
	...
	<script type="text/javascript" src="js/SeleccionReporteDefectos-v1.0.js"></script>
