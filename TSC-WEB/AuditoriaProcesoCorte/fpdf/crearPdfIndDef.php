...
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("INDICADORES DE DEFECTOS DE AUDITORÍA PROCESO DE CORTE"),0,0,'C');
$pdf->Ln();
...
$sql="BEGIN SP_APCR_INDDEF(:CODTLL,:CODSED,:CODTIPSER,:OPCION,:CODDEF,:OUTPUT_CUR); END;";
