...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte Auditor&iacute;as Aprobadas sin Clasificaci&oacute;n</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			<?php 
				...
				if($_GET['codusu']!=0){
					...
					$titulo.="USUARIO: (TODOS) / Desde ";
				}
				$ar_fecini=explode("-",$_GET['fecha']);
				$titulo.=$ar_fecini[2]."-".$ar_fecini[1]."-".$ar_fecini[0];
			?>
			...
			<div class="mayorContent">
				<div class="rowLine" style="display: block;width: 1610px;">
			...
			onclick="exportar_repregcla('<?php echo $_GET['codtll']; ?>',<?php echo $_GET['codusu']; ?>,<?php echo $_GET['codtad']; ?>,
			'<?php echo $_GET['fecha']; ?>','<?php echo $_GET['codsede']; ?>','<?php echo $_GET['codtipser']; ?>','<?php echo $titulo;?>')">
