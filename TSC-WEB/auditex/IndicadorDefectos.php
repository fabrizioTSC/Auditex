...
<body>
	...
	<div class="modalContainer" id="idModal">
		<div class="modalBackground" style="max-height: calc(100vh - 60px);overflow-y: scroll;">
			...
			<div class="lblTitulo" style="color: #000;">INDICADOR DE DEFECTO: <span id="idDesDef"></span></div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2"># PRE. MUE.</div>
	...
	<script type="text/javascript" src="js/IndicadorDefectos-v1.7.js"></script>
