...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte de Fichas sin Iniciar</div>
				...
				<div class="rowLine sizerTbl" style="display: block;">
					<div class="tblPrendasDefecto" style="position: relative;">
						<div class="tblHeader" id="tbl-header" style="position: relative;z-index: 10;"> 
							...
							<div class="itemHeader2" style="width: 100px;">Fec. Envio</div>
	...
	<script type="text/javascript" src="js/FichasSinIni-v1.1.js"></script>
