...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro de Fichas sin Iniciar</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="sameLine">
				...
				<input type="number" id="idnumdias" class="iptClass" style="width: 80px;font-size: 15px;" value="2">
			</div>
			<!--
	...
	<script type="text/javascript" src="js/FiltroFicSinIni-v1.0.js"></script>
