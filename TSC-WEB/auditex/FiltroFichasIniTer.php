...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro de Fichas Iniciadas o Terminadas</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine">				
				<div class="sameLine">
					<div class="lblNew" style="width: 140px;padding-top: 8px;">Desde:</div>
			...
			<div class="rowLine">				
				<div class="sameLine">
					<div class="lblNew" style="width: 140px;padding-top: 8px;">Hasta:</div>
			...
			<div class="rowLine" style="display: flex;">		
				<div class="sameLine">				
					<div class="lblNew" style="width: 130px;padding-top: 5px;">Tipo:</div>
					<select id="idTipMov" class="classCmbBox" style="width: calc(100% - 130px);font-size: 15px;">
	...
	<script type="text/javascript" src="js/FiltroFicIniTer-v1.0.js"></script>
