	...
	if (codsede_var=="") {
		...
		if (codtipser_var=="") {
			...
			if (codtll_var=="") {
				...
				/*window.location.href="EvolucionIndicador.php?codsede="+codsede_var+"&codtipser="+codtipser_var+
				"&codtll="+codtll_var+"&fecha="+document.getElementById("idFecha").value+"&type="+type+"&num="+num;*/
				window.location.href="EvolucionIndicador.php?codsede="+codsede_var+"&codtipser="+codtipser_var+
				"&codtll="+codtll_var+"&type="+type+"&num="+num;
			}
		}
	}
}