...
function validacionTallas(partir){
	...
	if(!error){
		...
		alert("La cantidad de una de las tallas es mayor a la cantidad máxima");
		...
		if (cantidadIngresada > fsfpcantidad) {
			...
			validacionTallas(function(){
				...
				for(let item of tallas){
					...
					saveTallas(fsfpcodfic,fsfpnumvez,fsfpparte,idtalla,cant);
...
function saveTallas(ficha,vez,parte,idtalla,cant){
