...
function cargarDatos(codFic,codtll,tipoMuestra,numMuestra,numvez,parte,codtad,codaql,codusu,codusuario,tipoauditoria){
	...
	$.ajax({
		...
		success:function(data){
			...
			if(data.state==true){
				...
				"&tipoAuditoria="+tipoAuditoria+"&cantidadDeMuestra="+cantidadDeMuestra+"&resultado="+estadoAuditoria+
				"&codaql="+fichaCodAql+"&fichatipoauditoria="+fichatipoauditoria;
			}else{
				alert(data.error.description);
				$(".panelCarga").fadeOut(300);
			}
