				...
				success:function(data){
					...
					if (data.ficpen.length!=0) {
						...
						for (var i = 0; i < data.ficpen.length; i++) {
							html_aux+=
								'<div class="tblLine">'+
									'<div class="itemBody" style="width: 30%;">'+data.ficpen[i].PARTE+'</div>'+
									'<div class="itemBody" style="width: 30%;">'+data.ficpen[i].NUMVEZ+'</div>'+
									'<div class="itemBody" style="width: 40%;">'+data.ficpen[i].CANPAR+'</div>'+
								'</div>';
						}
