...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro de Evoluci&oacute;n de Indicador</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="sameLine" style="font-weight: bold;">
				Semanas <input type="checkbox" id="opcion1" checked>
			</div>
			<div class="rowLine" id="detalle1">
				<div class="sameLine">
					<div class="lblNew" style="width: 140px;padding-top: 8px;">Num. semanas:</div>
					<input type="number" id="idsem" class="iptClass" style="width: calc(80px);font-size: 15px;" value="12">
				</div>
			</div>
			<div style="width: 100%;height: 10px;"></div>
			<div class="sameLine" style="font-weight: bold;">
				Meses <input type="checkbox" id="opcion2">
			</div>
			<div class="rowLine" id="detalle2" style="display: none">
				<div class="sameLine">
					<div class="lblNew" style="width: 140px;padding-top: 8px;">Num. meses:</div>
					<input type="number" id="idmes" class="iptClass" style="width: calc(80px);font-size: 15px;" value="12">
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="js/SeleccionEvoInd-1.0.js"></script>
