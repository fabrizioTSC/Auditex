...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte de Fichas sin Terminar</div>
				...
				<div class="rowLine sizerTbl" style="display: block;">
					<div class="tblPrendasDefecto" style="position: relative;">
						<div class="tblHeader" id="tbl-header" style="position: relative;z-index: 10;"> 
							...
							<div class="itemHeader2" style="width: 100px;">Fec. Inicio</div>
							<div class="itemHeader2" style="width: 80px;">N° de d&iacute;as</div>
						</div>
	...
	<script type="text/javascript">
		...
		var numdias="<?php echo $_GET['numdias']; ?>";
	</script>
	<script type="text/javascript" src="js/FichasSinTer-v1.0.js"></script>
