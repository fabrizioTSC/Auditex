...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte 4</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine bodyPrimary" style="display: flex;">
				<button class="btnPrimary" style="width: auto;margin-right: 5px;" onclick="consultar('Reporte4.php')">Consultar</button>
				<div class="btnPrimary" style="width: 135px;margin-right: 5px;
				padding: 5px;display: flex;padding-left: 20px;" onclick="exportar4()" id="spaceBtnExport">
			...
			<div style="margin-top: 10px;width: 100%;">
				<div class="rowLine" style="display: block;">
					<div class="tblPrendasDefecto" style="overflow-x: scroll;">
						<div class="tblHeader tblExpanded2">
							<div class="itemHeader2 verticalHeader itemSpace1">Ficha</div>
							...
							<div class="itemHeader2 verticalHeader itemSpace4">Cant. Total</div>
							<div class="itemHeader2 verticalHeader itemSpace5">Porcentaje</div>
						</div>
						<div class="tblBody tblExpanded2">
				<?php
				...
				?>
							<div class="tblLine">
								<div class="itemBody2 itemSpace1"><?php echo $row['CODFIC']; ?></div>
								...
								<div class="itemBody2 itemSpace2"><?php echo utf8_encode($row['DESDEF']); ?></div>
