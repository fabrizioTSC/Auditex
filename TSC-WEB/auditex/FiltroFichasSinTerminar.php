...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro de Fichas sin Terminar</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 80px;padding-top: 7px;">N° de d&iacute;as</div>
				<input type="number" id="idnumdias" class="iptClass" style="width: 80px;font-size: 15px;" value="7">
			</div>
			<!--
	...
	<script type="text/javascript" src="js/FiltroFicSinTer-v1.0.js"></script>
