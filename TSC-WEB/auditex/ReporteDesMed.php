...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="title-medida">Fecha desde: <?php echo $_GET['fecini']." hasta ".$_GET['fecfin']; ?></div>
			...
			<button class="btnPrimary" style=" margin: 5px 0;margin-left: calc(50% - 80px);" onclick="downloadPDF()" id="btndescarga">Descargar</button>
			<button class="btnPrimary" style="margin: 5px 0;margin-left: calc(50% - 80px);" onclick="window.history.back();">Volver</button>
			<div id="content-main">
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="js/ReporteDesMed-v1.1.js"></script>
