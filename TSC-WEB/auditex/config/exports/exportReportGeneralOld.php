...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo format_decimal($row['MINSTD']); ?></td>
			<td style="border:1px solid #333;"><?php echo format_decimal($row['MINADIEST']); ?></td>
			<td style="border:1px solid #333;"><?php echo format_decimal($row['MINCOMFIC']); ?></td>
			<td style="border:1px solid #333;"><?php echo format_decimal($row['MINTOT']); ?></td>
