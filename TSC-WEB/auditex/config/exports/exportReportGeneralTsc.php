	...
	<tbody>
		<?php 
			// while ($row=oci_fetch_assoc($OUTPUT_CUR)) {
				foreach($_SESSION["data_reporte_auditoriafinal_tsc"] as $row) {
		?>
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo $row['MINSTD']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['MINADIEST']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['MINCOMFIC']; ?></td>
			<td style="border:1px solid #333;"><?php echo $row['MINTOT']; ?></td>
			...
			<td style="border:1px solid #333;"><?php echo utf8_encode($row['DESPRE']); ?></td>
