...
header("Expires: 0");
$filename = "Reporte_fichas_sin_iniciar.xls";
...
$sql="begin SP_AT_SELECT_FICSININI(:CODTLL,:CODSED,:CODTIPSER,:NUMDIAS,:OUTPUT_CUR); END;";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte fichas sin iniciar</div>
<br>
...
<table>
	<thead>
		<tr>
			...
			<th style="border:1px solid #333;">Fecha Env&iacute;o</th>
	...
	<tbody>
		...
		<tr>
			...
			<td style="border:1px solid #333;"><?php echo $row['FECENV'];?></td>
