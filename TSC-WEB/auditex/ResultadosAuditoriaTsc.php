...
<body onload="getTalleres()">
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">	
			...
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 80px;padding-top: 5px;">Cliente</div>
				<input type="text" id="nombreCliente" class="iptClass" style="width: calc(100% - 80px);font-size: 15px;">
			</div>
			<div class="tblSelection">
				<div class="listaCliente" id="spaceClientes">
			...
			<div class="sameLine">
				...
				<input type="text" id="nombrePedido" class="iptClass" style="width: calc(100% - 80px);font-size: 15px;">
			</div>

			<!-- COLOR -->
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 80px;padding-top: 5px;">Color</div>
				<input type="text" id="nombreColor" class="iptClass" style="width: calc(100% - 80px);font-size: 15px;">
			</div>

			<!-- PO -->
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 80px;padding-top: 5px;">PO</div>
				<input type="text" id="nombrePo" class="iptClass" style="width: calc(100% - 80px);font-size: 15px;">
			</div>
	...
	<script type="text/javascript" src="js/ResultadosAuditoria-v1.0Tsc.js"></script>
