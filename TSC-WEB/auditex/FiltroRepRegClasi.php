...
<body onload="getTalleres()">
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro Registro de Clasificaci&oacute;n</div>
		...
		<div class="bodyContent" style="padding-bottom: 0px;padding-top: 0px;">
			<div class="rowLine bodyPrimary">
				<button class="btnPrimary" style="margin-left: calc(50% - 80px);margin-bottom: 10px;" onclick="mostraDatos()">Mostrar reporte</button>
			</div>		
		</div>
	</div>
	<script type="text/javascript" src="js/FiltroRepRegClasi-v1.0.js"></script>
