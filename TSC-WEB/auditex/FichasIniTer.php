...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte de Fichas Iniciadas o Terminadas</div>
				...
				<div class="rowLine sizerTbl" style="display: block;">
					<div class="tblPrendasDefecto" style="position: relative;">
						<div class="tblHeader" id="tbl-header" style="position: relative;z-index: 10;">
							...
							<div class="itemHeader2" style="width: 100px;">Cliente</div>
							...
							<div class="itemHeader2" style="width: 100px;">Tipo</div>
	...
	<script type="text/javascript" src="js/FichasIniTer-v1.2.js"></script>
