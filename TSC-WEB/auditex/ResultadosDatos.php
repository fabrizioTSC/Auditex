...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">REPORTE GENERAL DE AUDITORÍA FINAL DE COSTURA <?= $_GET["codcliente"]!= "0" ? ": ". $_GET["descripcioncliente"] : null  ?> </div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			...
			<?php
				...
				$_SESSION["data_reporte_auditoriafinal"] = [];

				$hideButtton="";
			?>
			<div class="mayorContent" id="ctrl-div">
				<div class="rowLine" style="display: block;width: 2040px;">
					<div class="tblPrendasDefecto" style="position: relative;">
						<div class="tblHeader">
							...
							<div class="itemHeader2 verticalHeader" style="width: 120px;">PO</div>
							...
							<div class="itemHeader2 verticalHeader" style="width: 80px;">T. STD</div>
							<div class="itemHeader2 verticalHeader" style="width: 80px;">T. Comp. Estilo</div>
							<div class="itemHeader2 verticalHeader" style="width: 80px;">T. Comp. Ficha</div>
							<div class="itemHeader2 verticalHeader" style="width: 80px;">Min. Totales</div> -->
							...
							<div class="itemHeader2 verticalHeader" style="width: 90px;">Defectos Encontrados</div>
							<div class="itemHeader2 verticalHeader" style="width: 200px;">Defectos</div>
							<div class="itemHeader2 verticalHeader" style="width: 130px;">Cantidad por Defectos</div>
							...
							<div class="itemHeader2 verticalHeader" style="width: 90px;">Partida.</div>
							<div class="itemHeader2 verticalHeader" style="width: 120px;">Tipo Tela.</div>
							<div class="itemHeader2 verticalHeader" style="width: 90px;">Color.</div>
				...
				?>
							<div class="tblLine">
								...
								<div class="itemBody2" style="width: 200px;"><?php echo $row['DESCDEFECTOS']; ?></div>
								<div class="itemBody2" style="width: 130px;"><?php echo $row['CANTDEFECTOS']; ?></div>
								...
								<div class="itemBody2" style="width: 120px;"><?php echo utf8_encode($row['TIPOTELA']); ?></div>
								<div class="itemBody2" style="width: 90px;"><?php echo utf8_encode($row['COLOR']); ?></div>
								<div class="itemBody2" style="width: 150px;"><?php echo utf8_encode($row['OBSERVACIONES']); ?></div>
	...
	<script type="text/javascript" src="js/graficasDatos-v1.0.js"></script>
