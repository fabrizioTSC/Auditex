...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			-->		
			<div id="place-detalle">
				<h4 style="">Ruta actual: <span id="rutpdf"></span></h4>
				<div class="lineDecoration"></div>
			</div>
			<center>
				<button class="btnPrimary" style="margin: 5px 0;" onclick="cargar_medidas();">Generar medidas</button>
			</center>
			<center>
				<button class="btnPrimary" style="margin: 5px 0;" onclick="show_pdf();">Ver PDF</button>
			</center>
			<center>
				<button class="btnPrimary" style="margin: 5px 0;" onclick="cargar_pdf();">Cargar PDF</button>
			</center>
			<input type="file" id="newfile" onchange="charge_pdf()" style="display: none;">
			<center>
				<button class="btnPrimary" style="margin: 5px 0;" onclick="window.history.back();">Volver</button>
			</center>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function cargar_medidas(){
			window.location.href="GenMedv2.php?po="+po+"&paclis="+paclis;
		}
		function show_pdf(){
			var a=document.createElement("a");
			a.href="http://textilweb.tsc.com.pe:81/TSC-WEB/pdf-ReportesLE/"+document.getElementById("rutpdf").innerHTML;
			a.target="_blank";
			a.click();
		}
		$(document).ready(function(){
			$.ajax({
				...
				success:function(data){
					...
					if (data.RUTPDF=="") {
						document.getElementById("place-detalle").style.display="none";
					}else{
						document.getElementById("rutpdf").innerHTML=data.RUTPDF;
					}
