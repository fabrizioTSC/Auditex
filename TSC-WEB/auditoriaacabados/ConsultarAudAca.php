...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Consultar auditoria acabados</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-top: 10px;">
			...
			<div id="main-content" style="display: none;">
				...
				<a onclick="ctrl_header()" id="ctrl-header" style="text-decoration: underline;color: blue;font-size: 12px;">Ocultar detalle ficha</a>
				<div id="detalle-checklist" style="display: none;width: 100%;">
					...
					<a onclick="ctrl_partevez()" id="ctrl-partevez" style="text-decoration: underline;color: blue;font-size: 12px;">Ocultar inicio</a>
					<div id="det-chelisparvez" style="display: none;">						
						...
						<a onclick="ctrl_header_dos()" id="ctrl-header-2" style="text-decoration: underline;color: blue;font-size: 12px;">Ocultar detalle</a>
						<div class="lineDecoration"></div>
						<div style="margin-top: 10px;">
							<a onclick="ctrl_chelisdoc()" id="ctrl-chelisdoc" style="font-weight: bold;">1. Validación de documentación (<span style="text-decoration: underline;color: blue;" id="text-doc">Ocultar</span>)</a>
						</div>
						...
						<div class="lineDecoration"></div>
						<div style="margin-top: 10px;">
							<a onclick="ctrl_defectos()" id="ctrl-defectos" style="font-weight: bold;">2. Defectos (<span style="text-decoration: underline;color: blue;" id="text-def">Mostrar</span>)</a>
						</div>
						...
						<div class="lineDecoration"></div>
						<div style="margin-top: 10px;">
							<a onclick="ctrl_acabados()" id="ctrl-acabados" style="font-weight: bold;">3. Proceso de acabados (<span style="text-decoration: underline;color: blue;" id="text-aca">Mostrar</span>)</a>
						</div>
						...
						<div id="acabados" style="display: none;">
							...
							<div style="margin-top: 5px;">
								<div onclick="ctrl_codigo()" style="text-decoration: underline;color: blue;"><span id="text-codigo">Ocultar</span> código</div>
							</div>
							<div style="display: flex;justify-content: flex-end;margin-top: 5px;align-items: center;">
								<label>TODOS</label>
								<div class="check-content">
				...
				<div id="detalle-humedad" style="display: none;">
					...
					<div class="lineDecoration"></div>
					<center>
						<button class="btnPrimary" onclick="volver()" style="margin: auto;margin-top: 10px;">Volver</button>
					</center>
				</div>
	...
	<script type="text/javascript">
		var codfic_aut="<?php if (isset($_GET['codfic'])) { echo $_GET['codfic'];}else{ echo ''; } ?>";
		...
		$(document).ready(function(){
			...
			get_defectos();
			if (codfic_aut!="") {
				$("#codfic").val(codfic_aut);
				document.getElementById("redirect-2").click();
			}
		...
		function show_chelisparvez(parte,numvez){
			...
			$.ajax({
				...
				success:function(data){
					...
					document.getElementById("obs-aca").innerHTML=data.OBSPRO;
					...
					if (!data.state) {
						...
						for (var i = 0; i < data.chelisavi.length; i++) {
							...
							'<tr>'+
								...
								'<td>'+
									'<div class="check-content">'+
										'<div class="marker-check anicheblo3-dos" onclick="change_check1_dos(this)" id="cheblo3-dos-'+data.chelisavi[i].CODAVIO+'">NO</div>'+
									'</div>'+
								'</td>'+
							'</tr>';
						}
