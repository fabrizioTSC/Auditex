...
function exportar_veremp(codusu,codtad,fecini,fecfin,titulo,codsede,codtipser,codcel){
	var a=document.createElement('a');
	a.target="_blank";
	a.href="config/exports/exportReportGeneralVerEmp.php?codusu="+codusu+"&codtad="+codtad+"&fecini="+fecini+"&fecfin="+fecfin+"&titulo="+titulo
	+"&codsede="+codsede+"&codtipser="+codtipser+"&codcel="+codcel;
	a.click();
}
