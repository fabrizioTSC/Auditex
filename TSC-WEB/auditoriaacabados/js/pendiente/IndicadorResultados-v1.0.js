	...
	$.ajax({
		...
		success:function(data){
			...
			for (var i = 0; i < data.anios.length; i++) {
				var PorAudApro=Math.round(data.anios[i]['AUD_APR']*10000/data.anios[i]['AUD_TOT'])/100;
				var styleC="colorB";
				...
				'<div class="divanios[i]">'+
					...
					'<div class="itemhs1 items4">'+formatNumber(data.anios[i]['AUD_APR'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.anios[i]['AUD_REC'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.anios[i]['AUD_TOT'])+'</div>'+
				...
				var PorAudAproP=0;
				if (auditoriasTotales!=0) {
					PorAudAproP=Math.round(data.anios[i]['AUD_APR1']*10000/auditoriasTotales)/100;
				}	
				var styleC="colorB";
				var color=window.chartColors.yellow;
				...
				var PorPreAproP=0;
				if (prendasTotales!=0) {
					PorPreAproP=Math.round(data.anios[i]['PREN_APR1']*10000/prendasTotales)/100;
				}
				htmlps+=
				'<div class="divanios[i]">'+
					'<div class="itemhs1">'+data.anios[i]['ANHO']+'</div>'+
			...
			for (var i = 0; i < data.meses.length; i++) {
				var PorAudApro=Math.round(data.meses[i]['AUD_APR']*10000/data.meses[i]['AUD_TOT'])/100;
				var styleC="colorB";
				var color=window.chartColors.yellow;
				if (PorAudApro>=param_codran1) {
					styleC="colorA";
				...
				'<div class="divanios[i]">'+
					...
					'<div class="itemhs1 items4">'+formatNumber(data.meses[i]['AUD_APR'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.meses[i]['AUD_REC'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.meses[i]['AUD_TOT'])+'</div>'+
					'<div class="itemhs1 items4 '+styleC+'">'+PorAudApro+'%</div>'+
					'<div class="itemhs1 items4">'+Math.round((100-PorAudApro)*100)/100+'%</div>'+
					'<div class="itemhs1 items3"></div>'+
				...
				var PorAudAproP=0;
				if (auditoriasTotales!=0) {
					PorAudAproP=Math.round(data.meses[i]['AUD_APR1']*10000/auditoriasTotales)/100;
				}	
				var styleC="colorB";
				var color=window.chartColors.yellow;
				if (PorAudAproP>=param_codran1) {
				...
				var PorPreAproP=0;
				if (prendasTotales!=0) {
					PorPreAproP=Math.round(data.meses[i]['PREN_APR1']*10000/prendasTotales)/100;
				}
				htmlps+=
				'<div class="divanios[i]">'+
					'<div class="itemhs1">'+proceMes(data.meses[i]['MES'])+'</div>'+
			...
			for (var i = 0; i < data.semanas.length; i++) {
				var PorAudApro=Math.round(data.semanas[i]['AUD_APR']*10000/data.semanas[i]['AUD_TOT'])/100;
				var styleC="colorB";
				var color=window.chartColors.yellow;
				if (PorAudApro>=param_codran1) {
					styleC="colorA";
				...
				'<div class="divanios[i]">'+
					...
					'<div class="itemhs1 items4">'+formatNumber(data.semanas[i]['AUD_APR'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.semanas[i]['AUD_REC'])+'</div>'+
					'<div class="itemhs1 items4">'+formatNumber(data.semanas[i]['AUD_TOT'])+'</div>'+
					'<div class="itemhs1 items4 '+styleC+'">'+PorAudApro+'%</div>'+
					'<div class="itemhs1 items4">'+Math.round((100-PorAudApro)*100)/100+'%</div>'+
					'<div class="itemhs1 items3"></div>'+
				...
				var PorAudAproP=0;
				if (auditoriasTotales!=0) {
					PorAudAproP=Math.round(data.semanas[i]['AUD_APR1']*10000/auditoriasTotales)/100;
				}				
				var styleC="colorB";
				var color=window.chartColors.yellow;
				if (PorAudAproP>=param_codran1) {
				...
				var PorPreAproP=0;
				if (prendasTotales!=0) {
					PorPreAproP=Math.round(data.semanas[i]['PREN_APR1']*10000/prendasTotales)/100;
				}
				htmlps+=
				'<div class="divanios[i]">'+
					'<div class="itemhs1">S. '+data.semanas[i]['NUMERO_SEMANA']+'</div>'+
			...
			for (var i = 0; i < data.defectosU.length; i++) {
				...
				'<div class="lineBody">'+
					...
					'<div class="itemhs1 items4" style="width: 100px;">'+Math.round(data.defectosU[i]['SUMA']*10000/data.sumDU)/100+'%</div>'+
				'</div>';		
			...
			for (var i = 0; i < data.defectosD.length; i++) {
				...
				'<div class="lineBody">'+
					...
					'<div class="itemhs1 items4" style="width: 90px;">'+Math.round(sumPor*100)/100+'%</div>'+
					'<div class="itemhs1 items3" style="width: 50px; background:transparent;border-color:transparent;"></div>'+
					'<div class="itemhs1 items4" style="width: 100px;">'+Math.round(data.defectosD[i]['SUMA']*10000/data.sumDU)/100+'%</div>'+
				'</div>';		
			...
			for (var i = 0; i < data.defectosUM.length; i++) {
				...
				'<div class="lineBody">'+
					...
					'<div class="itemhs1 items4" style="width: 90px;">'+Math.round(sumPor*100)/100+'%</div>'+
					'<div class="itemhs1 items3" style="width: 50px; background:transparent;border-color:transparent;"></div>'+
					'<div class="itemhs1 items4" style="width: 100px;">'+Math.round(data.defectosUM[i]['SUMA']*10000/data.sumDUM)/100+'%</div>'+
				'</div>';		
			...
			for (var i = 0; i < data.defectosDM.length; i++) {
				...
				'<div class="lineBody">'+
					...
					'<div class="itemhs1 items4" style="width: 90px;">'+Math.round(sumPor*100)/100+'%</div>'+
					'<div class="itemhs1 items3" style="width: 50px; background:transparent;border-color:transparent;"></div>'+
					'<div class="itemhs1 items4" style="width: 100px;">'+Math.round(data.defectosDM[i]['SUMA']*10000/data.sumDUM)/100+'%</div>'+
				'</div>';		
