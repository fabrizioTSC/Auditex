...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte Auditorias por Auditor Check List Proceso Acabados</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			if (isset($_GET['fecini'])) {
				...
				$sql="BEGIN SP_AA_REPACA_EJECUTIVO(:FECINI,:FECFIN,:OPCION,:OUTPUT_CUR); END;";
