...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Indicador de Resultados Verificado de Empaque Acabados</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE AUDITOR&Iacute;A VERIFICADO DE EMPAQUE ACABADOS - GENERAL</div>
			...
			<div class="contentTbl">
				<div class="lateralHeAders">
					...
					<div class="items1 items2">CAJA APROB. 1RA</div>
					<div class="items1 items2">CAJA RECH.</div>
