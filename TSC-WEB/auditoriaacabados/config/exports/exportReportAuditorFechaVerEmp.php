...
header("Expires: 0");
$filename = "Reporte_numero_de_auditorías_por_Auditor_y_Fecha_Verificado_Empaque.xls";
...
?>
<div style="font-size: 20px;font-weight: bold;">Reporte de n&uacute;mero de auditor&iacute;as por Auditor y Fecha de Verificado de Empaque</div>
<br>
