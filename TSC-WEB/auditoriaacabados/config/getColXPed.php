<?php
	...
	$reportever = isset($_POST["reporte"]) ? true : false;
	
	// CARGAMOS MEDIDAS SI NO EXISTEN
	$responsesige_avios = "";
	$responsesige_cajas = "";
	$responsesige_packing = "";

	if(!$reportever || $_SESSION["user"] != "OGARCIA"){

		// CARGAMOS LA AVIOS
		// $responsesige_avios 	= $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[6,$_POST['pedido']],"Correcto");

		// // EJECUTAMOS CARGA DEL SIGE
		// $responsesige_cajas 			= $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[3,$_POST['pedido']],"Correcto");
		// // CARGAMOS PACKING LIST
		// $responsesige_packing 	= $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[4,$_POST['pedido']],"Correcto");

		$responsesige_cajas 	= $objModelo->setAll("USYSTEX.SPU_DELETEPEDIDOSSIGE",[$_POST['pedido']],"Correcto");

		
		$responsesige_avios 	= $objModelo->setAllSQLSIGE("uspSetGeneraDataAuditex",[10,$_POST['pedido']],"Correcto");
	...
	$response->responsesige_avios = $responsesige_avios;
	$response->responsesige_cajas = $responsesige_cajas;
	$response->responsesige_packing = $responsesige_packing;
