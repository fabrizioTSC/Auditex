			...
			<div id="main-content" style="display: none;">
				...
				<div id="detalle-audmed" style="display: none;">
					...
					<div style="margin-top: 5px;" id="div-obs-aca">
						<div class="lblNew" style="width: 100px;margin-right: 5px;">Usuario:</div>
						<input style="padding: 5px;font-family: sans-serif;width: calc(100% - 12px);" id="idUsuarioMedida" readonly />
					</div>
					<div style="margin-top: 5px;" id="div-obs-aca">
						<div class="lblNew" style="width: 100px;margin-right: 5px;">Observación:</div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if (data.state) {
						...
						$("#idUsuarioMedida").val(data.datos.CODUSU);
