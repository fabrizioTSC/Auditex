...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Indicador de Resultados Check List Proceso Acabados</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE CHECK LIST PROCESO ACABADOS - GENERAL</div>
	...
	<script type="text/javascript" src="js/IndicadorResultados-v1.2.js"></script>
