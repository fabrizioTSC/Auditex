...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte por Auditor y Fecha</div>
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine bodyPrimary" style="display: flex;">
				<button class="btnPrimary" style="width: auto;margin-right: 5px;" onclick="consultar('ReporteAuditorFecha.php')">Consultar</button>
				<div class="btnPrimary" style="width: 135px;margin-right: 5px;
				padding: 5px;display: flex;padding-left: 20px;" onclick="exportarAuditorFecha()" id="spaceBtnExport">
			...
			if (isset($_GET['fecini'])) {
				...
				$sql="BEGIN SP_APCR_REPORTES_EJECUTIVO(:FECINI,:FECFIN,:OPCION,:OUTPUT_CUR); END;";
			...
			<div style="margin-top: 10px;width: 100%;">
				<div class="rowLine" style="display: block;">
					<div class="tblPrendasDefecto" style="overflow-x: scroll;">
						<div class="tblHeader" style="width: 800px">
						...
						<div class="tblBody" style="width: 800px">
				<?php
	...
	<script type="text/javascript" src="js/ReportesEjecutivo-v1.0.js"></script>
