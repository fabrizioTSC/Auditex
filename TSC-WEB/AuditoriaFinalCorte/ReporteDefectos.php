...
<body>
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Reporte de defectos de auditoría final de corte</div>
		...
		<div class="bodyContent mainBodyContent" style="padding-bottom: 0px;">	
			...
			<?php
				...
				$sql="BEGIN  SP_AFC_REPORTE_DEFECTOS(:FECINI,:FECFIN,:CODTLL,:CODCEL,:CODUSU,:CODSED,:CODTIPSER,:OUTPUT_CUR); END;";
				$stmt=oci_parse($conn, $sql);
