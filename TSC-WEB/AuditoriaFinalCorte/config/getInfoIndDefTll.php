<?php
	...
	$i=0;
	if ($_POST['tipo']=="1") {
		$sql="BEGIN SP_AFC_INDICADOR_DEF_RD_ALL(:CODTLL,:CODSED,:CODTIPSER,:CODDEF,:OUTPUT_CUR,:NUMANIO,:NUMSEM); END;";
		...
		$sql="BEGIN SP_AFC_INDICADOR_DEF_RD_RF(:CODTLL,:CODSED,:CODTIPSER,:CODDEF,:OUTPUT_CUR,:FECINI,:FECFIN); END;";
		$stmt=oci_parse($conn, $sql);
		oci_bind_by_name($stmt, ':CODTLL', $_POST['codtll']);
		oci_bind_by_name($stmt, ':CODSED', $_POST['codsede']);
		oci_bind_by_name($stmt, ':CODTIPSER', $_POST['codtipser']);
