...
?>	
	<div class="menuContent">
		<div class="spaceMenu">
			<div class="userSpace">
				<div class="titleversion">AUDITORIA FINAL DE CORTE v2.0- 01/04/2020</div>
	...
	<div class="bodyContent mainBodyContent" style="padding-top: 10px;">		
		<div class="rowLine" style="display: flex;">
			<div class="itemMainContent">
				<div class="bodySpecialButton" onclick="redirect('IniciarAuditoriaFinalCorte.php')">
					<div class="icon"><i class="fa fa-book" aria-hidden="true"></i></div>
					<div class="detailSpecialButton">REGISTRAR AUDITORIA FINAL CORTE</div>
				</div>
			</div>
			<div class="itemMainContent">
		...
		<div class="rowLine" style="display: flex;">
			...
			<div class="itemMainContent">
				<div class="bodySpecialButton" onclick="/*click_input()*/redirect('CargarMedidasCSV.php')">
					<div class="icon"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></div>
		...
		<div class="rowLine" style="display: flex;">
			...
			<div class="itemMainContent">
				<div class="bodySpecialButton" onclick="redirect('ConsultarEditarEstTsc.php')">
					<div class="icon"><i class="fa fa-book" aria-hidden="true"></i></div>
					<div class="detailSpecialButton">EDITAR MEDIDAS AUDITABLES ESTILO TSC</div>
				</div>
			</div>
		</div>
		<div class="rowLine" style="display: flex;">
		...
		<div class="rowLine" style="display: flex;">
			<div class="itemMainContent">
				<div class="bodySpecialButton" onclick="redirect('SeleccionRepLogCar.php')">
					<div class="icon"><i class="fa fa-area-chart" aria-hidden="true"></i></div>
					<div class="detailSpecialButton">REPORTE LOG CARGA DE MEDIDAS</div>
				</div>
			</div>
			<div class="itemMainContent">
