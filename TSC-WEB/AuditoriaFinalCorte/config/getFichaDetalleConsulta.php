<?php
	...
	$ficha->MOLDE_USAR_HILO=$row['MOLDE_USAR_HILO'];
	$ficha->MOLDE_USAR_TRAMA=$row['MOLDE_USAR_TRAMA'];
	$ficha->MOLDE_USAR_MANGA=$row['MOLDE_USAR_MANGA'];

	// MOLDE_USAR_HILO, MOLDE_USAR_TRAMA, MOLDE_USAR_MANGA
