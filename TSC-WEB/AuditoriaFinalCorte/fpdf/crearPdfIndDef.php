...
$pdf->Cell($pdf->get_max_width_to_white(),6,utf8_decode("INDICADORES DE DEFECTOS DE AUDITORÍA FINAL DE CORTE"),0,0,'C');
$pdf->Ln();
...
$sql="BEGIN SP_AFC_INDICADOR_DEFECTOS(:CODTLL,:CODSED,:CODTIPSER,:OPCION,:CODDEF,:OUTPUT_CUR); END;";
