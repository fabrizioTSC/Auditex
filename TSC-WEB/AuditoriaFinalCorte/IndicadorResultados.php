...
<body>
	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="lblTitulo">INDICADORES DE RESULTADOS DE AUDITOR&Iacute;A FINAL DE CORTE</div>
			...
			<div class="firstGraph">
				<div class="contentGraph" style="min-width: 700px;">
					<canvas id="chart-area2" width="700" height="400"></canvas>
				</div>
			</div>
			...
			<div class="firstGraph">
				<div class="contentGraph" style="min-width: 700px;">
					<canvas id="chart-area3" width="700" height="500"></canvas>
				</div>
			</div>
			<div class="contentTbl" style="display: block;">
			...
			<div class="firstGraph">
				<div class="contentGraph" style="min-width: 700px;">
					<canvas id="chart-area3-mes" width="700" height="500"></canvas>
				</div>
			</div>
			<div class="contentTbl" style="display: block;">
				<div class="tblSpace" style="width: 535px;">
	...
	<script type="text/javascript" src="js/IndicadorResultados-v1.4.js"></script>
