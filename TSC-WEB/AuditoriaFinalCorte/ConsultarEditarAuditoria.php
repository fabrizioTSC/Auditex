...
<body onload="verificarPerfil(<?php echo $_SESSION['perfil'];?>)">
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Consultar / Editar Auditoria Final de Corte</div>
		...
		<div class="bodyContent" id="idContentForFicha" style="display: none;">			
			...
			<div class="spaceInLine"></div>
			<div class="lblNew" style="width: 220px;">ENCOGIMIENTO DE MOLDE</div>
			<div class="rowLine bodySecondary" style="display: block;">
				<div class="tblDistributionTalla">
					<div class="tblHeader">
						<div class="itemHeader" style="width: 33.33%;">HILO</div>						
						<div class="itemHeader" style="width: 33.33%;">TRAMA</div>						
						<div class="itemHeader" style="width: 33.34%;">MANGA</div>						
					</div>
					<div class="tblBody" id="idTblEnco">
					</div>
				</div>
			</div>
			...
			<div class="btnPrimary btnSpecialStyle solocorte" onclick="newdefecto()" style="margin-top: 10px; width: 250px;margin-right: auto;margin-left: auto;">Añadir defecto</div>
		...
		<div class="btnPrimary btnSpecialStyle" onclick="redirect('main.php');" style="width: 200px;margin: auto;">Terminar</div>
		<div class="btnPrimary btnSpecialStyle" onclick="window.history.back();" style="width: 200px;margin: auto;margin-top: 10px;">Volver</div>
	</div>
	...
	<script type="text/javascript" src="js/consultarEditarAuditoria-v1.8.js"></script>
	<script type="text/javascript" src="js/animacionesGlobales.js"></script>
	<script type="text/javascript">

		let SOLOCORTE = <?=   isset($_GET["solocorte"]) ? "true" : "false" ?>
