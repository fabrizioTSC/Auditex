...
function getTalleres(){
	$.ajax({
		type:"POST",
		url:"config/getFiltroRepAudPro.php",
		data:{
			request:"1"
		},
...
function enviarParametros(){
	var url="IndResAudPro.php?codsede="+codsede_var+"&codtipser="+codtipser_var+"&codtll="+codtll_var+"&fecha="+document.getElementById("idFecha").value;
