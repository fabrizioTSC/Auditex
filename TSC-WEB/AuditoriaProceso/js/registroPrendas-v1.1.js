	...
	if (auditoriaDefecto=="") {
		...
		if (auditoriaOperacion=="") {
			...
			if ($("#idCanPren").val()=="") {
				...
				var contentModal="";
				contentModal+=
				'<div class="lineModalBody"><div class="lblLineModalBody">DEFECTO:</div>'+auditoriaDefecto+'</div>'+
				'<div class="lineModalBody"><div class="lblLineModalBody">OPERACION:</div>'+auditoriaOperacion+'</div>'+
				'<div class="lineModalBody"><div class="lblLineModalBody">CANTIDAD:</div>'+canPrendas+'</div>';
				$(".modalBody").append(contentModal);
