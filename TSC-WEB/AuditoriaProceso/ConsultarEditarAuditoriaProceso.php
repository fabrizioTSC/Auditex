	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">	
			...
			<div id="spaceResultado" style="display: none;">
				...
				<div class="btnPrimary btnSpecialStyle" onclick="contunieAudPro()" style="margin-bottom: 5px; width: calc(80% - 20px); margin-left: 10%;display:none">Continuar auditoria</div>
