<?php
	...
	if (isset($_POST['codfic'])) {
		...
		if(oci_num_rows($stmt)==0){
			$sqlUpdate="UPDATE FICHAAUDITORIA set CODUSU='".$_POST['usuario']."'".
			" where CODFIC=".$_POST['codfic'].
			" and CODTAD=".$_POST['codtad']." and NUMVEZ=".$_POST['numvez']." and PARTE=".$_POST['parte'].
		...
		$sql="select * from AUDITORIADETALLEDEFECTO where CODFIC=".$_POST['codfic'].
		" and CODTAD=".$_POST['codtad']." and NUMVEZ=".$_POST['numvez']." and PARTE=".$_POST['parte'].
		...
		if (oci_num_rows($stmt)==0) {
			$sqlInsert="INSERT INTO AUDITORIADETALLEDEFECTO ".
			"VALUES ".
			"(".$_POST['codfic'].","
			.$_POST['codtad'].",'"
