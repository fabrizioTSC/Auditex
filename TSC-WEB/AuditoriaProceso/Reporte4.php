	...
	<div class="mainContent">
		...
		<div class="bodyContent mainBodyContent">
			...
			<div class="rowLine bodyPrimary">
				<button class="btnPrimary" style="margin-left: calc(50% - 80px);" onclick="consultar('Reporte4.php')">Consultar</button>
			</div>		
			<?php
			if (isset($_GET['fecini'])) {
				...
				$sql="select ae.codtll, t.destll, ad.coddef, d.desdef,  sum(ad.candef) candef, t.cantot, round(100*(sum(ad.candef)/t.cantot) ,2) Por
			...
			<div style="margin-top: 10px;width: 100%;">
				...
				?>
					...
					padding: 5px;display: flex;padding-left: 20px;" onclick="exportar4()">
