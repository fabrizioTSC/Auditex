...
<body onload="getTalleres()">
	...
	<div class="mainContent">
		<div class="headerContent">
			<div class="headerTitle">Filtro Rep. Aud. Proceso</div>
		...
		<div class="bodyContent mainBodyContent">	
			...
			<div style="width: 100%;height: 20px;"></div>
			<div class="sameLine">
				<div class="lblNew" style="width: 120px;padding-top: 5px;">Taller</div>
				<input type="text" id="nombreTaller" class="iptClass" style="width: calc(100% - 120px);font-size: 15px;">
			</div>
			<div class="tblSelection">
			...
			<div class="option-line">
				...
				<div class="class-for-selects">
					<input type="date" id="rango1" class="special-input" data-ctrl="ipt3" style="margin-right: 5px" disabled/>
					<input type="date" id="rango2" class="special-input" data-ctrl="ipt3" style="margin-left: 5px" disabled/>
				</div>
			</div>
			-->
		</div>
		<div class="bodyContent" style="padding-bottom: 0px;padding-top: 0px;">
			<div class="rowLine bodyPrimary">
				<button class="btnPrimary" style="margin-left: calc(50% - 80px);margin-bottom: 10px;" onclick="enviarParametros()">Mostrar resultado</button>
			</div>		
		</div>
	</div>
	<script type="text/javascript" src="js/FiltroReporteAudPro-v1.0.js"></script>
